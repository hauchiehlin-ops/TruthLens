  ...
  const content = {
    en: {
      ...
      cards: [
        ...
        'Free short-text preview',
        'Traditional Chinese short-text preview',
      ],
      status:
    ...
    'zh-Hans': {
      ...
      introPrefix: '先试用公开入口：',
      introLinks: ['免费 AI 文章检测器', 'Free AI Detector', '本地 AI 检测与云端上传比较'],
      guideLabel: '公开工具与指南',
      cards: [
        '本地 AI 检测与云端上传比较',
        'PDF AI 检测限制',
    ...
    ja: {
      ...
      introLinks: ['無料 AI 文章検出ツール', 'Free AI Detector', 'ローカル AI 検出とクラウドアップロードの比較'],
    ...
    ko: {
      ...
      introLinks: ['무료 AI 글 감지기', 'Free AI Detector', '로컬 AI 감지와 클라우드 업로드 비교'],
    ...
    th: {
      ...
      introLinks: ['ตัวตรวจบทความ AI ฟรี', 'Free AI Detector', 'การตรวจ AI ในเครื่องเทียบกับคลาวด์'],
      ...
      cards: [
        ...
        'ตัวอย่างข้อความสั้นฟรี (จีนตัวเต็ม)',
        'Free short-text preview',
      ],
    ...
    ms: {
      ...
      introLinks: ['Pengesan artikel AI percuma', 'Free AI Detector', 'Pengesanan AI setempat berbanding awan'],
      ...
      cards: [
        ...
        'Pratonton teks pendek percuma (Cina Tradisional)',
        'Free short-text preview',
      ],
    ...
    es: {
      ...
      introLinks: ['Detector gratuito de artículos IA', 'Free AI Detector', 'Detección local de IA frente a la nube'],
      ...
      cards: [
        ...
        'Vista previa breve gratuita (chino tradicional)',
        'Free short-text preview',
      ],
    ...
    id: {
      ...
      introLinks: ['Detektor artikel AI gratis', 'Free AI Detector', 'Deteksi AI lokal vs cloud'],
      ...
      cards: [
        ...
        'Arti low burstiness',
        'Pratinjau teks pendek gratis (Tionghoa Tradisional)',
        'Free short-text preview',
      ],
    ...
    ru: {
      ...
      introLinks: ['Бесплатный детектор AI-текстов', 'Free AI Detector', 'Локальная AI-проверка и облако'],
      ...
      cards: [
        ...
        'Бесплатный короткий предпросмотр (традиционный китайский)',
        'Free short-text preview',
      ],
    ...
    de: {
      ...
      introLinks: ['Kostenloser KI-Artikelprüfer', 'Free AI Detector', 'Lokale KI-Erkennung statt Cloud'],
      ...
      cards: [
        ...
        'Kostenlose Kurztext-Vorschau (trad. Chinesisch)',
        'Free short-text preview',
      ],
    ...
    fr: {
      ...
      introLinks: ['Détecteur gratuit d’articles IA', 'Free AI Detector', 'Détection IA locale ou cloud'],
      ...
      cards: [
        ...
        'Aperçu court gratuit (chinois traditionnel)',
        'Free short-text preview',
      ],
    ...
    pt: {
      ...
      introLinks: ['Detector gratuito de artigos IA', 'Free AI Detector', 'Detecção local de IA versus nuvem'],
      ...
      cards: [
        ...
        'Prévia curta gratuita (chinês tradicional)',
        'Free short-text preview',
      ],

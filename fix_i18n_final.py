...
# Remove any existing changelog keys everywhere to be clean
...
translations = {
    ...
    'es': ['Últimas actualizaciones', 'v6.0.0 - Cambio de marca a OmniTrace con un nuevo logotipo de análisis multidimensional.', 'v5.0.0 - Se agregó motor SEO programático y páginas estáticas multilingues.', 'Detección de contenido IA y análisis documental local primero.'],
...
with open('web/seo/home_i18n.js', 'w', encoding='utf-8') as f:
    f.write(content)
print("Fixed home_i18n.js correctly")

...
class AppLocalizationsEn extends AppLocalizations {
  ...
  @override
  String get onboardingWelcomeTitle => 'Welcome to OmniTrace';
  ...
  String reportEngineSignalLabel(int percent) {
    return 'AI signal index $percent/100';
  }
  ...
  @override
  String get historyUntitledDocument => 'Untitled document';
  ...
  @override
  String get helpCascadeTitle => '3. Tiered analysis and integrated assessment';
  ...
  String abstentionTooFewSentences(int count, int required) {
    return 'Only $count analysable sentence(s), where at least $required are needed to measure segment stability. Confidence is reduced, but eligible document-level signals may still contribute.';
  }
  ...
  String reportBibUncertainNoReliableResponse(String base) {
    return '$base: verification sources returned no reliable response or the entry lacks enough information; OmniTrace does not treat this citation as verified.';
  }
  ...
  @override
  String get exportReportTitle => 'OmniTrace Detection Report';
  ...
  String composerHeadlineLikelyAi(int percent) {
    return 'This text is more likely AI-generated; further review is recommended (integrated AI likelihood $percent%)';
  }
  ...
  String composerHeadlineLikelyHuman(int percent) {
    return 'This text is more likely not AI-generated (integrated AI likelihood $percent%)';
  }
  ...
  String engineReasonStatisticalSummaryAi(String percent) {
    return 'Overall statistical summary: leans towards AI-generated characteristics (signal index $percent/100)';
  }

  @override
  String engineReasonStatisticalSummaryHuman(String percent) {
    return 'Overall statistical summary: leans towards human natural writing (AI signal index $percent/100)';
  }

  @override
  String engineReasonStatisticalSummaryNeutral(String percent) {
    return 'Overall statistical summary: qualified indicators point in different directions (AI signal index $percent/100)';
  }
  ...
  @override
  String get helpAboutTitle => 'About OmniTrace';
  ...
  @override
  String get helpAdvantagesTitle => 'OmniTrace-only advantages';
  ...
  String workspacePreliminaryVerdict(int percent) {
    return 'Preliminary AI evidence index: $percent/100';
  }
  ...
  String telemetrySummarySingleSource(String engine) {
    return 'Only $engine produced a usable direction; the other engines turned up nothing this time. The conclusion rests on a single analysis axis, so treat its confidence accordingly.';
  }

  @override
  String telemetrySummarySilentEngines(int count) {
    return '$count further engine(s) ran but formed no directional signal, and were excluded so that \'nothing to report\' is not miscounted as \'looks human-written\'.';
  }
  ...
  @override
  String get settingsEngineLlmTitle => 'Report-writing LLM';
  ...
  @override
  String get publicGuideMenuTitle => 'Public tools and guides';

  @override
  String get publicGuideFreeDetector => 'Free short-text detector';

  @override
  String get publicGuideZhDetector => 'Traditional Chinese detector';

  @override
  String get publicGuideLocalVsCloud => 'Local AI detection vs cloud upload';

  @override
  String get publicGuidePdfLimits => 'PDF AI detection limits';

  @override
  String get publicGuideDocxEvidence => 'DOCX editing history evidence';

  @override
  String get publicGuideLowBurstiness => 'Low burstiness in AI writing';

  @override
  String get publicGuideFakeCitations => 'Fake citations and reference checks';
}

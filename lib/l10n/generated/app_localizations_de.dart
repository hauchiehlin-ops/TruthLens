...
class AppLocalizationsDe extends AppLocalizations {
  ...
  @override
  String get firstRunModelPromptTitle => 'Ein Erkennungsmodell hinzufügen?';

  @override
  String get firstRunModelPromptBody =>
      'OmniTrace funktioniert bereits: Die statistischen und stilistischen Module sind sofort einsatzbereit. Mit einem lokalen neuronalen Modell nimmt zusätzlich der mehrsprachige Klassifikator an der Ensemble-Abstimmung teil, was Genauigkeit und Sprachabdeckung deutlich verbessert. Das Modell läuft vollständig in Ihrem Browser und lädt Ihre Dokumente niemals hoch. Sie können sich auch später unter „Einstellungen → KI-Modellverwaltung“ entscheiden.';

  @override
  String get firstRunModelPromptLater => 'Jetzt nicht';

  @override
  String get firstRunModelPromptGo => 'Modell auswählen';

  @override
  String get modernChineseModelPromptTitle => 'Chinesisch-Erkennung verbessern';

  @override
  String get modernChineseModelPromptBody =>
      'Für dieses chinesische Dokument fehlt derzeit der moderne Chinesisch-Detektor (ca. 98 MB). Das ältere mehrsprachige Modell wurde auf Texten früherer Generationen kalibriert und übersieht aktuelles chinesisches Schreiben im Stil von DeepSeek, Gemini oder GPT leicht. Laden Sie das spezialisierte lokale Modell für ein besser kalibriertes Ergebnis herunter, oder fahren Sie mit dem schwächeren sprachübergreifenden Ersatz fort.';

  @override
  String get onboardingWelcomeTitle => 'Willkommen bei OmniTrace';
  ...
  @override
  String get onboardingBundleTitle => 'Empfehlung für dieses Gerät';

  @override
  String onboardingBundleSummary(int count, String size) {
    return '$count Modelle · insgesamt $size MB';
  }

  @override
  String onboardingBundleStorage(String available, String remaining) {
    return 'Browser-Speicher: $available MB verfügbar, nach dem Download bleiben etwa $remaining MB';
  }

  @override
  String get onboardingStorageNotPersisted =>
      'Heruntergeladene Modelle sind noch nicht vor der automatischen Bereinigung geschützt. Wird der Speicherplatz knapp, kann der Browser sie entfernen und Sie müssten erneut herunterladen. Wenn Sie OmniTrace als App installieren, behält der Browser sie mit deutlich höherer Wahrscheinlichkeit.';

  @override
  String get onboardingInstallAppButton => 'Als App installieren';
  ...
  String reportEngineDirectionalIndex(int percent) {
    return 'Schwache Richtung $percent/100';
  }
  ...
  @override
  String get historyUntitledDocument => 'Unbenanntes Dokument';
  ...
  String get privacySealNoticeText =>
      'OmniTrace Zero-Cloud-Datenschutzsiegel: 100% lokale Ausführung auf dem Gerät ohne Cloud-Speicherung.';
  ...
  @override
  String get reportNoEngineData => 'Keine Modul-Daten';

  @override
  String get ocrGeminiKeyRequired =>
      'Geben Sie zuerst einen Gemini-API-Schlüssel ein.';

  @override
  String get ocrGeminiKeyValid =>
      'Gemini-API-Schlüssel ist gültig und erreichbar.';

  @override
  String get ocrGeminiKeyUnreachable =>
      'Gemini-API nicht erreichbar. Bitte prüfen Sie den Schlüssel.';

  @override
  String get ocrStatusLocalUnset => 'Lokale OCR: Endpunkt nicht gesetzt';

  @override
  String get ocrStatusLocalUntested =>
      'Lokale OCR: Endpunkt gesetzt, ungetestet';

  @override
  String get ocrStatusLocalTesting => 'Lokale OCR: Verbindung wird getestet';

  @override
  String get ocrStatusLocalReady => 'Lokale OCR: bereit';

  @override
  String get ocrStatusLocalUnreachable => 'Lokale OCR: nicht erreichbar';

  @override
  String get ocrStatusGeminiUnset => 'Gemini: kein Schlüssel gesetzt';

  @override
  String get ocrStatusGeminiUntested => 'Gemini: Schlüssel gesetzt, ungetestet';

  @override
  String get ocrStatusGeminiVerifying => 'Gemini: Schlüssel wird geprüft';

  @override
  String get ocrStatusGeminiValid => 'Gemini: Schlüssel gültig';

  @override
  String get ocrStatusGeminiInvalid => 'Gemini: ungültig oder nicht erreichbar';

  @override
  String get ocrActiveLocalVerified =>
      'Aktive Engine: lokaler OCR-Server (geprüft)';

  @override
  String get ocrActiveLocalUntested =>
      'Aktive Engine: lokaler OCR-Server (noch ungetestet)';

  @override
  String get ocrActiveGeminiVerified => 'Aktive Engine: Gemini-API (geprüft)';

  @override
  String get ocrActiveGeminiUntested =>
      'Aktive Engine: Gemini-API (noch ungetestet)';

  @override
  String get ocrActiveNone => 'Noch keine OCR-Engine konfiguriert';

  @override
  String get ocrDetectAndDownload => 'System erkennen und Installer laden';

  @override
  String get ocrAutoInstallUnavailable =>
      'Automatische Installation nicht verfügbar';

  @override
  String get ocrUnsupportedPlatformBody =>
      'Die aktuelle Plattform ist kein unterstütztes Ziel für die Ein-Klick-Installation. Ein Webbrowser kann unter iOS, Android, Linux oder einem unbekannten System keinen lokalen OCR-Dienst installieren und starten.\n\nMöglichkeiten:\n1. Nutzen Sie diesen Assistenten in einem macOS- oder Windows-Desktopbrowser.\n2. Verwenden Sie einen Gemini-API-Schlüssel als Web-OCR-Ersatz.\n3. Fortgeschrittene können das OCR-Projekt öffnen, selbst einen kompatiblen /ocr-Endpunkt betreiben und die URL hier eintragen.';

  @override
  String ocrInstallerReady(String osName) {
    return '$osName-Installer ist bereit';
  }
  ...
  String get ocrRunInstructionWindows =>
      'setup_and_run_ocr.bat im Ordner \"Downloads\" doppelklicken';
  ...
  String ocrAssistantDownloadedBody(
    ...
    return '$osName wurde erkannt und der lokale Endpunkt automatisch eingetragen:\n$endpoint\n\nIhr Browser lädt $fileName herunter. Aus Sicherheitsgründen kann OmniTrace Web den Installer nicht selbst ausführen oder Starteinstellungen ändern.\n\nNächste Schritte:\n1. Installer ausführen: $runInstruction\n2. Warten, bis Terminal oder Fenster meldet, dass der OCR-Dienst bereit ist.\n3. Hierher zurückkehren und „$testButton“ wählen.\n\nNach erfolgreichem Test nutzt die Bild-OCR zuerst diesen lokalen Dienst. Bilder gehen nicht an Gemini, sofern Sie nicht zusätzlich einen Gemini-API-Schlüssel als Ersatz einrichten.';
  }
  ...
  String get abstentionNoEvidenceFound =>
      'Alle Module liefen, aber keines fand verwertbare Belege. Der niedrige Ersatzwert ist eine Diagnoseausgabe und kein Beleg dafür, dass ein Mensch den Text geschrieben hat.';

  @override
  String abstentionSingleWeakEvidenceSource(int count) {
    return 'Nur $count Modul fand verwertbare Belege, und der Gesamtwert liegt weiterhin unter der KI-Schwelle. Werten Sie das als geringe Abdeckung, nicht als Beleg für menschliche Urheberschaft.';
  }
  ...
  String reportBibUncertainNoReliableResponse(String base) {
    return '$base: Verifizierungsquellen lieferten keine zuverlässige Antwort, oder dem Eintrag fehlen ausreichende Informationen; OmniTrace behandelt dieses Zitat nicht als verifiziert.';
  }
  ...
  @override
  String get exportReportTitle => 'OmniTrace-Erkennungsbericht';

  @override
  String pdfPageFooter(int page, int total) {
    return 'OmniTrace · Seite $page / $total';
  }
  ...
  String engineReasonBurstinessMid(String value) {
    return 'Die Satzlängenvariation (Burstiness $value) blieb im neutralen Bereich 0,30–0,55';
  }
  ...
  String engineReasonMattrNoAiSignal(String value, String cut) {
    return 'Die Wortschatzvielfalt (MATTR $value) überschritt die kalibrierte KI-Signalgrenze $cut nicht';
  }
  ...
  String get modelNameMbertMultilingual =>
      'Mehrsprachiger Detektor (EN+ZH · INT8)';

  @override
  String get modelNameTruthlensZh =>
      'OmniTrace Chinesisch-Detektor (Generation 2026 · INT8)';

  @override
  String get modelNameAigcZhv3 =>
      'Moderner Chinesisch-Detektor (DeepSeek/GPT-4 · INT8)';

  @override
  String get modelNameRobertaEn => 'RoBERTa-Detektor (Englisch · ChatGPT)';

  @override
  String get modelNameQwenPpl =>
      'Mehrsprachiges Perplexitätsmodell (Qwen2.5-0.5B · INT8)';

  @override
  String get modelNameDistilgpt2Ppl => 'DistilGPT2-Perplexitätsmodell (INT8)';

  @override
  String get modelNameAdversarial => 'Umschreibungs-Detektor (INT8)';

  @override
  String get modelErrorNoSource =>
      'Für diese Variante gibt es noch keine Download-Quelle.';

  @override
  String modelErrorStorageShort(String mb) {
    return 'Zu wenig Browser-Speicher — es fehlen etwa $mb MB. Entfernen Sie nicht mehr benötigte Modelle oder geben Sie Speicherplatz frei.';
  }

  @override
  String get modelErrorChecksum =>
      'Prüfsumme stimmt nicht überein — die Datei ist möglicherweise beschädigt.';

  @override
  String get modelErrorTokenizerIncomplete =>
      'Die heruntergeladene Tokenizer-JSON ist unvollständig oder die Verbindung brach ab.';

  @override
  String modelErrorSizeMismatch(String got, String expected) {
    return 'Unvollständiger Download: $got MB empfangen, erwartet wurden etwa $expected MB.';
  }

  @override
  String get modelErrorChunkAborted =>
      'Der Download wurde mitten im Block unterbrochen; wiederholte Versuche schlugen fehl.';

  @override
  String get modelErrorTokenizerInvalid => 'Ungültige Tokenizer-JSON.';
  ...
  @override
  String get deviceCapabilityEstimated => ' (geschätzt)';
  ...
  String engineReasonPan25LexicalHuman(int percent) {
    return 'Der lexikalische Fingerabdruck PAN 2025 tendiert zum Menschen ($percent/100); das bleibt Modellevidenz und ist kein Nachweis der Urheberschaft';
  }

  @override
  String engineReasonPan25LexicalNeutral(int percent) {
    return 'Der lexikalische Fingerabdruck PAN 2025 ist neutral ($percent/100) und gibt keine Richtung vor';
  }

  @override
  String engineReasonDetectRlZhAi(int percent) {
    return 'Der chinesische Zeichen-Fingerabdruck von DetectRL-ZH überschritt die konservative KI-Beweisschwelle ($percent/100); er wurde unabhängig gegen DeepSeek-V3, Mischtexte, Rückübersetzung, Zeichenstörungen und unterschiedliche Längen geprüft';
  }

  @override
  String engineReasonDetectRlZhNoAiSignal(int percent) {
    return 'Der chinesische Zeichen-Fingerabdruck von DetectRL-ZH überschritt die konservative KI-Beweisschwelle nicht ($percent/100); das ist eine Enthaltung und kein Beleg dafür, dass ein Mensch den Text geschrieben hat';
  }

  @override
  String engineReasonCompressionCoherence(String value) {
    return 'Die grenzüberschreitende Kompressionskohärenz ($value) übersteigt das 95.-Perzentil-Screening menschlicher Texte aus PAN 2025 [schwaches Signal auf KI-Seite]';
  }

  @override
  String engineReasonAssistantResponseArtifact(int count) {
    return '$count Artefakt(e) einer dialogorientierten Assistentenantwort erkannt, etwa das Ansprechen der anfragenden Person oder das Angebot, den gewünschten Text zu überarbeiten';
  }
  ...
  String get helpVsGptZero1 =>
      'GPTZero arbeitet überwiegend in der Cloud und verlangt das Hochladen des Dokuments; alle vier OmniTrace-Engines laufen in Ihrem eigenen Browser, der Inhalt wird nirgendwohin gesendet.';

  @override
  String get helpVsGptZero2 =>
      'GPTZero war Pionier bei Perplexity/Burstiness-Metriken und Satzhervorhebung — OmniTrace kombiniert diese und fügt einen Transformer-Klassifikator, stilometrische Analyse und adversariale Abwehr hinzu, wodurch eine Ensemble-Abstimmung aus vier Modellen statt einer einzigen Metrik entsteht.';

  @override
  String get helpVsGptZero3 =>
      'GPTZero basiert auf Abonnements; OmniTrace erfordert kein Abonnement und hat keine Nutzungsbeschränkungen.';
  ...
  String get helpVsTurnitin1 =>
      'Turnitin wird nur an Institutionen verkauft; Einzelpersonen können es nicht direkt kaufen. Jeder kann OmniTrace installieren und verwenden.';

  @override
  String get helpVsTurnitin2 =>
      'Der Entscheidungsprozess von Turnitin ist fast eine Blackbox; OmniTrace liefert die KI-Wahrscheinlichkeit jedes Satzes, passende Schreibmuster sowie die Aufschlüsselung von Punktzahl und Gründen jeder Engine.';

  @override
  String get helpVsTurnitin3 =>
      'Turnitin liefert größtenteils ein binäres \"ist es KI\"-Ergebnis; OmniTrace unterstützt die Kennzeichnung von Mensch/KI/Gemischt auf Absatz-/Satzebene.';
  ...
  String get helpVsOriginality1 =>
      'Originality.ai rechnet pro Text im Abo ab und verlangt den Upload in die Cloud; OmniTrace erledigt die Kernarbeit im Browser, ohne Abo und ohne Nutzungsgrenze.';

  @override
  String get helpVsOriginality2 =>
      'Originality.ai bietet Konzepte für Faktenprüfung und Lesbarkeitsanalyse; OmniTrace reagiert darauf mit einem Stilmerkmalmodul auf dem Gerät und kann grundlegende Analysen sogar offline durchführen.';
  ...
  String get helpVsWinston1 =>
      'Die Bild-OCR von Winston AI lädt das Bild in die Cloud. Die OCR von OmniTrace bevorzugt einen von Ihnen eingerichteten lokalen OCR-Server und weicht nur dann in die Cloud aus, wenn Sie selbst einen Gemini-API-Schlüssel hinterlegen — ob überhaupt Cloud im Spiel ist, bleibt Ihre Entscheidung.';

  @override
  String get helpVsWinston2 =>
      'Winston AI ist bekannt für ordentliche, druckbare Berichte; OmniTrace generiert das Berichtslayout dynamisch per KI (fällt auf eine Vorlage zurück, wenn kein LLM installiert ist), exportierbar als PDF/CSV/JSON/PNG.';

  @override
  String get helpAdvantagesTitle => 'Exklusive Vorteile von OmniTrace';
  ...
  String get helpWorkflowStep1Body =>
      'Die App startet immer auf dem Hauptbildschirm. Ist beim ersten Start noch kein Erkennungsmodell installiert, fragt ein Hinweis, ob Sie eines auswählen möchten — lehnen Sie ab, können Sie sofort mit den statistischen und stilistischen Modulen analysieren. Modelle lassen sich jederzeit unter „Einstellungen → KI-Modellverwaltung“ prüfen, herunterladen, aktualisieren oder entfernen. Die App sucht beim Start aktiv nach der neuesten Version und markiert das Einstellungssymbol sowie den Eintrag „KI-Modellverwaltung“, wenn ein Update vorliegt.';
  ...
  String get helpWorkflowStep2Bullet1 =>
      'Mehrsprachiger KI-Klassifikator (Gewicht 40 %): analysiert begrenzte Absatzblöcke, um den Kontext zu erhalten, und überträgt die Wahrscheinlichkeiten anschließend zurück auf die Sätze, um Belege pro Satz zu liefern. Sind mehrere Klassifikator-Varianten installiert, wählt jede Analyse diejenige aus, die für die Sprache des Dokuments validiert ist — chinesische Dokumente benötigen den eigenen modernen Chinesisch-Detektor, und die App weist darauf hin, wenn dieses Modell fehlt.';
  ...
  String get privacyWebOverview1 =>
      'OmniTrace läuft vollständig als Web-App in Ihrem Browser-Tab. Es muss nichts installiert werden; Dokumenttext und Analyseergebnisse verlassen Ihr Gerät nie, und heruntergeladene Erkennungsmodelle werden nur im eigenen isolierten Speicher Ihres Browsers (OPFS) zwischengespeichert, nicht auf einem Server.';
  ...
  String get privacyIosOverview1 =>
      'OmniTrace sammelt keine Daten, die mit Ihrer Identität verknüpft sind, und verwendet keine Daten zum Tracking, sodass keine App-Tracking-Transparenz-Berechtigung (ATT) erforderlich ist.';
  ...
  String get privacyAndroidOverview1 =>
      'OmniTrace sammelt keine personenbezogenen Daten und gibt keine Benutzerdaten an Dritte weiter.';
  ...
  String get privacyMacosOverview1 =>
      'OmniTrace läuft unter der macOS-App-Sandbox und kann nur auf Dateien zugreifen, die Sie aktiv über den System-Dateidialog auswählen (files.user-selected.read-write) — sie kann nicht selbstständig andere Dateien oder Ordner durchsuchen oder darauf zugreifen.';
  ...
  String get privacyWindowsOverview1 =>
      'OmniTrace ist eine eigenständige Desktop-Anwendung; Daten werden in Ihrem lokalen Benutzerordner gespeichert (z. B. AppData/Documents) und niemals mit der Cloud synchronisiert.';
  ...
  String get privacyDataHandling1 =>
      'OmniTrace hat keine Benutzerkonten, erfordert keine Anmeldung und enthält in keiner Form Werbe- oder Tracking-SDKs von Dritten.';

  @override
  String get privacyDataHandling2 =>
      'Jeglicher Dokumentinhalt, den Sie eingeben, einfügen oder importieren, wird vollständig von KI-Modellen auf Ihrem eigenen Gerät analysiert — er wird niemals auf OmniTrace oder Server Dritter hochgeladen.';

  @override
  String get privacyDataHandling3 =>
      'Analyseergebnisse und Verlauf werden nur in einer lokalen Datenbank auf Ihrem Gerät gespeichert; das Deinstallieren der App oder das Löschen des Verlaufs entfernt sie vollständig — OmniTrace speichert keine Kopien an anderer Stelle.';
  ...
  String get privacyDisclaimer =>
      'Diese Seite ist eine von OmniTrace verfasste Datenschutzerklärung, die das tatsächliche Funktionsverhalten widerspiegelt, kein formelles, von einem Anwalt geprüftes Rechtsdokument; für eine formelle Compliance-Prüfung nach den Gesetzen Ihrer Region konsultieren Sie bitte einen unabhängigen Anwalt.';
  ...
  String reportEngineRelationshipDirectionalOnly(String engine, int weight) {
    return '$engine fand nur ein schwaches gerichtetes Signal. Es wird beim Screening abgewertet und zählt nicht als schwellenqualifizierter Beleg (Obergrenze der Rollengewichtung $weight %).';
  }
  ...
  String findingPublicationPredatesGenerativeAi(String doi, int year) {
    return 'Die Quellen-DOI $doi passt zu diesem Dokument und wurde $year registriert, also vor modernen generativen KI-Schreibsystemen.';
  }

  @override
  String findingPublicationIdentityMismatch(String doi) {
    return 'Die Quellen-DOI $doi lässt sich auflösen, aber ihr registrierter Titel passt nicht zu diesem Dokument. Prüfen Sie die Identität des Dokuments, bevor Sie sich darauf stützen.';
  }

  @override
  String get integratedStabilityUnavailable =>
      'Segmentstabilität nicht verfügbar · kein satzweiser Beleg hat abgestimmt';

  @override
  String get integratedNeutralBaseline =>
      'Es wurden keine urheberschaftsspezifischen Belege gefunden, die stark genug für eine Hochstufung wären. Das gezeigte Ergebnis ist das bestmögliche gerichtete Screening und keine Aussage, dass sich KI- und Menschenbelege die Waage halten.';
  ...
  @override
  String get evidenceMatrixTitle => 'Bewertung über mehrere Beweisachsen';

  @override
  String get evidenceMatrixSubtitle =>
      'Sechs Achsen werden getrennt ausgewiesen. Nur urheberschaftsspezifische Belege beeinflussen das Urteil; die Abdeckung zeigt, was überhaupt prüfbar war.';

  @override
  String evidenceMatrixCoverage(int available, int total) {
    return 'Beweisabdeckung: $available von $total Achsen';
  }

  @override
  String get evidenceAxisText => 'Spuren der Textgenerierung';

  @override
  String get evidenceAxisTextNote =>
      'Wahrscheinlichkeitsmuster der vier lokalen Detektoren';

  @override
  String get evidenceAxisProcess => 'Schreibprozess';

  @override
  String get evidenceAxisProcessNote =>
      'Tipp-, Überarbeitungs- und Einfügeereignisse, erfasst ohne deren Inhalt zu speichern';

  @override
  String get evidenceAxisOrigin => 'Dokumentherkunft';

  @override
  String get evidenceAxisOriginNote =>
      'Bearbeitungszeit, Speichervorgänge und DOCX-/ODT-/RSID-Metadaten';

  @override
  String get evidenceAxisSources => 'Integrität von Aussagen und Quellen';

  @override
  String get evidenceAxisSourcesNote =>
      'Prüfbare Aussagen, Zitationsanker und bibliografische Verifizierung';

  @override
  String get evidenceStateUnavailable => 'Nicht verfügbar';

  @override
  String get evidenceStateInconclusive => 'Nicht schlüssig';

  @override
  String get evidenceStateReassuring => 'Stimmig';

  @override
  String get evidenceStateConcern => 'Prüfen';

  @override
  String get evidenceStrengthNone => 'Keine Belege';

  @override
  String get evidenceStrengthLimited => 'Begrenzt';

  @override
  String get evidenceStrengthModerate => 'Mittel';

  @override
  String get evidenceStrengthStrong => 'Stark';

  @override
  String get evidenceMatrixTextOnlyWarning =>
      'Nur die Achse der Textmuster war verfügbar. Aktuelle KI kann menschliche Prosa nachahmen, daher kann dieser Bericht die Urheberschaft nicht allein aus dem Wert ableiten.';

  @override
  String get evidenceMatrixStrongConcern =>
      'Mindestens eine unabhängige Achse enthält ein starkes Prüfsignal. Sehen Sie sich diesen Beleg an, bevor Sie sich auf den Textwert stützen.';

  @override
  String findingUnsupportedClaims(int unsupported, int total) {
    return '$unsupported von $total prüfbaren Aussagen enthalten Zahlen, Vergleiche oder Verweise auf Forschung ohne Quellenanker im selben Satz. Das beweist nicht, dass sie falsch sind, benennt aber die Aussagen, die zuerst zu prüfen sind.';
  }

  @override
  String get integratedAssessmentTitle => 'Integrierte Urheberschaftsbewertung';

  @override
  String get integratedInsufficientEvidence =>
      'Kein quantifizierbares Urheberschaftssignal';

  @override
  String get integratedLikelyAi => 'Eher KI-generiert';

  @override
  String get integratedLikelyMixed => 'Eher Mischung aus Mensch und KI';

  @override
  String get integratedLikelyHuman => 'Eher nicht KI-generiert';

  @override
  String get integratedBalanced =>
      'Kein eindeutig KI-dominantes Signal erkannt';

  @override
  String get integratedPreliminaryAi =>
      'Tendiert derzeit zu KI, nahe der Grenze';

  @override
  String get integratedPreliminaryHuman =>
      'Tendiert derzeit zum Menschen, nahe der Grenze';

  @override
  String integratedLikelihoodLabel(int percent) {
    return 'KI-Beweisindex: $percent/100';
  }

  @override
  String get integratedLikelihoodUnavailable =>
      'KI-Beweisindex: nicht schätzbar';

  @override
  String integratedTextScoreLabel(int percent) {
    return 'Textmodell-Wert: $percent %';
  }
  ...
  @override
  String get integratedConfidenceLow => 'Niedrig';

  @override
  String get integratedConfidenceModerate => 'Mittel';

  @override
  String get integratedConfidenceHigh => 'Hoch';

  @override
  String integratedEvidenceSufficiency(int percent, String tier) {
    return 'Beweiskraft: $percent/100 · $tier';
  }
  ...
  @override
  String get integratedEvidenceTierScreening => 'vorläufiges Screening';

  @override
  String get integratedEvidenceTierReference => 'als Referenz geeignet';

  @override
  String get integratedEvidenceTierStrong => 'gut belegt';

  @override
  String integratedBoundaryAi(int index, int gap) {
    return 'Index $index ist nur eine schwache Tendenz zur KI-Seite und liegt weiterhin $gap Punkte unter der Hochstufungsgrenze von 60 Punkten. Eine KI-Urheberschaft ist damit nicht belegt.';
  }

  @override
  String integratedBoundaryHuman(int index, int gap) {
    return 'Index $index tendiert zum Menschen und liegt weiterhin $gap Punkte unter der KI-Hochstufungsgrenze von 60 Punkten; die begrenzten Belege können eine KI-Unterstützung jedoch nicht ausschließen.';
  }

  @override
  String integratedEvidenceCoverage(int families, int coverage) {
    return 'Gerichtete Signalfamilien: $families/4 · Anwendbarkeitsabdeckung $coverage %';
  }

  @override
  String get integratedEvidenceGatePassed => 'KI-Beweisschwelle: erreicht';

  @override
  String get integratedEvidenceGateNotPassed =>
      'KI-Beweisschwelle: nicht erreicht · nur gerichtetes Screening';

  @override
  String integratedQualifiedWarning(String reason) {
    return '$reason Das System nennt weiterhin die wahrscheinlichste Richtung, aber mit verringerter Konfidenz; behandeln Sie sie als Screening-Ergebnis, nicht als Nachweis.';
  }

  @override
  String get integratedIndexCaveat =>
      'Die separate KI-Beweisschwelle zeigt an, ob die unabhängige Absicherung für eine Hochstufung ausreicht. Zitationsqualität, Einfügeverhalten und auffällige Metadaten können für sich genommen kein KI-Urteil begründen. Dies ist ein Beweiswert, keine kalibrierte statistische Wahrscheinlichkeit.';

  @override
  String get reportTextEngineSignalExplanation =>
      'Diese Balken zeigen Diagnosesignale der vier Textmodule. Verwandte Module werden nach Familie zusammengefasst — einschließlich konservativ abgewerteter Klassifikatorausgaben auf der Menschenseite —, bevor Sprach-/Domänenanwendbarkeit und Kalibrierungszuverlässigkeit angewendet werden. Die Richtung beantwortet, welche Erklärung besser gestützt ist; die separate KI-Beweisschwelle beantwortet, ob die Stützung für eine Hochstufung ausreicht.';

  @override
  String reportSynthesisTextScoreContext(int percent) {
    return 'Rohwert des Vier-Modul-Textmodells: $percent %. Das ist eine Eingangsgröße der integrierten Bewertung, kein zweites Urteil.';
  }

  @override
  String reportSynthesisStrongestTextSignal(String label, int percent) {
    return 'Stärkstes Textmodul-Signal: $label ($percent %). Es kann den Textmodell-Wert beeinflussen, die integrierte Bewertung aber nicht allein außer Kraft setzen.';
  }
  ...
  String composerTextScoreThresholdReached(
    ...
    return 'Der Rohwert des Textmodells beträgt $aiPercent % und erreicht die diagnostische Marke von $thresholdPercent %. Das ist nur eine Beobachtung des Textsignals; die integrierte Bewertung oben bleibt die Urheberschaftsrichtung des Berichts.';
  }
  ...
  String composerTextScoreThresholdNotReached(
    ...
    return 'Der Rohwert des Textmodells beträgt $aiPercent % und liegt unter der diagnostischen Marke von $thresholdPercent %. Das Verfehlen dieser Marke ist kein Beleg für menschliche Urheberschaft; die integrierte Bewertung oben bleibt die Urheberschaftsrichtung des Berichts.';
  }
  ...
  String telemetryIntegratedVerdict(
    ...
    return 'Nach Gewichtung der verfügbaren Belege gilt das Dokument als „$direction“ (KI-Beweisindex $percent/100, Konfidenz $confidence).';
  }

  @override
  String telemetryIntegratedUnavailable(String direction, String confidence) {
    return 'Die verfügbaren Module ergaben keine quantifizierbare Urheberschaftsrichtung („$direction“, Konfidenz $confidence); es wurde kein Zahlenindex ausgegeben.';
  }

  @override
  String integratedStabilityLabel(int percent, int lower, int upper) {
    return 'Segmentstabilität $percent % · Intervall $lower–$upper %';
  }

  @override
  String integratedInputQualityLabel(int percent) {
    return 'Qualität der Eingabeextraktion: $percent %';
  }

  @override
  String integratedCalibrationLabel(String value, int count) {
    return 'Passende lokale Referenz: p=$value · n=$count';
  }

  @override
  String analysisReadinessLabel(String level) {
    return 'Konfidenzbasis vor der Analyse: $level';
  }

  @override
  String get analysisReadinessShortText => 'mehr Text nötig';

  @override
  String get analysisReadinessFewSentences => 'zu wenige Segmente';

  @override
  String get analysisReadinessCoreModel => 'Kernklassifikator nicht verfügbar';

  @override
  String get analysisReadinessFewEngines => 'weniger als zwei Module aktiv';

  @override
  String get analysisReadinessExtraction => 'Extraktionsqualität ist begrenzt';

  @override
  String get analysisReadinessBaseline => 'keine passende lokale Referenz';

  @override
  String get ocrChipLocalVerified => 'Lokales OCR (geprüft)';

  @override
  String get ocrChipLocalUntested => 'Lokales OCR (ungeprüft)';

  @override
  String get ocrChipGeminiVerified => 'Gemini (geprüft)';

  @override
  String get ocrChipGeminiUntested => 'Gemini (ungeprüft)';

  @override
  String get ocrChipNone => 'OCR-Engine: nicht konfiguriert';

  @override
  String ocrErrorLocalServerReported(String detail) {
    return 'Der lokale OCR-Server hat einen Fehler gemeldet: $detail';
  }

  @override
  String get ocrErrorLocalServerFormat =>
      'Der lokale OCR-Server hat ein inkompatibles Antwortformat geliefert; erwartet wurde ein Array von Textblöcken, results[].text oder text.';

  @override
  String get ocrErrorNoTextDetected =>
      'OCR abgeschlossen, aber im Bild wurde kein verwertbarer Text gefunden.';

  @override
  String ocrErrorLocalServerStatus(String status, String detail) {
    return 'Lokaler OCR-Server antwortete mit HTTP $status: $detail';
  }

  @override
  String ocrErrorLocalUnreachable(String detail) {
    return 'Der lokale OCR-Server ist nicht erreichbar oder die Anfrage lief in eine Zeitüberschreitung: $detail';
  }

  @override
  String get ocrErrorNotConfigured =>
      'OCR ist noch nicht eingerichtet. Hinterlegen Sie in den Einstellungen einen Gemini-API-Schlüssel oder die URL eines lokalen OCR-Servers.';

  @override
  String get ocrErrorGeminiNoParsableText =>
      'Gemini hat geantwortet, die Antwort enthielt jedoch keinen lesbaren Text.';

  @override
  String get ocrErrorGeminiRateLimited =>
      'Gemini OCR hat ein Raten- oder Kontingentlimit erreicht (429). Versuchen Sie es später erneut oder wechseln Sie zu einem lokalen OCR-Server.';

  @override
  String ocrErrorGeminiBadRequest(String detail) {
    return 'Gemini OCR hat die Anfrage abgelehnt (400): $detail';
  }

  @override
  String get ocrErrorGeminiUnauthorized =>
      'Der Gemini-API-Schlüssel ist ungültig oder nicht autorisiert (401). Bitte fügen Sie einen gültigen Schlüssel erneut ein.';

  @override
  String ocrErrorGeminiHttpFailed(String status, String detail) {
    return 'Gemini OCR fehlgeschlagen (HTTP $status): $detail';
  }

  @override
  String ocrErrorGeminiException(String detail) {
    return 'Gemini OCR konnte keine Verbindung herstellen oder die Antwort nicht auswerten: $detail';
  }

  @override
  String get ocrErrorNoImageData =>
      'Es wurden keine Bilddaten empfangen. Bitte wählen Sie das Bild erneut aus; schlägt es weiterhin fehl, liefert der Browser möglicherweise keine Datei-Bytes.';

  @override
  String ocrErrorGeminiKeyInvalid(String status) {
    return 'Der Gemini-API-Schlüssel ist ungültig oder nicht autorisiert (HTTP $status).';
  }

  @override
  String ocrErrorGeminiTestFailed(String status) {
    return 'Verbindungstest der Gemini-API fehlgeschlagen (HTTP $status).';
  }

  @override
  String ocrErrorGeminiTestException(String detail) {
    return 'Verbindungstest der Gemini-API fehlgeschlagen: $detail';
  }

  @override
  String get ocrErrorNativePluginNoPing =>
      'Das native OCR-Plug-in dieser Plattform hat nicht auf einen Ping geantwortet.';

  @override
  String get ocrErrorNativePluginMissing =>
      'Auf dieser Plattform ist kein natives OCR-Plug-in registriert.';

  @override
  String ocrErrorNativeCheckFailed(String detail) {
    return 'Prüfung des nativen OCR-Plug-ins fehlgeschlagen: $detail';
  }

  @override
  String ocrErrorNativeFailed(String detail) {
    return 'Native OCR fehlgeschlagen: $detail';
  }

  @override
  String get settingsEngineLlmTitle => 'LLM für Berichtstexte';
  ...
  String get firstRunModelManualBody =>
      'Sie können die Modelle jederzeit selbst herunterladen: Öffnen Sie die Einstellungen (Zahnradsymbol in der oberen Leiste) und wählen Sie „KI-Modellverwaltung“. Bis dahin arbeitet OmniTrace mit seinen statistischen und stilistischen Engines weiter.';

...
class AppLocalizationsRu extends AppLocalizations {
  ...
  String get provenanceHowToGetRecord =>
      'Чтобы свидетельства происхождения приносили пользу, собирайте у учеников **исходный файл .docx или .odt**, а не распечатанный или выгруженный PDF. История правок сохраняется только в оригинале, и только он может автоматически попасть в эталон со статистической гарантией.';

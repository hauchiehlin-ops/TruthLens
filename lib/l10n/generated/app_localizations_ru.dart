...
class AppLocalizationsRu extends AppLocalizations {
  ...
  @override
  String get firstRunModelPromptTitle => 'Добавить модель обнаружения?';

  @override
  String get firstRunModelPromptBody =>
      'OmniTrace уже работает: статистический и стилистический движки готовы прямо сейчас. Если добавить локальную нейросетевую модель, к общему голосованию подключится многоязычный классификатор, что заметно повысит точность и охват языков. Модель выполняется полностью в вашем браузере и никогда не загружает ваши документы. Решить можно и позже — в разделе «Настройки → Управление моделями ИИ».';

  @override
  String get firstRunModelPromptLater => 'Не сейчас';

  @override
  String get firstRunModelPromptGo => 'Выбрать модель';

  @override
  String get modernChineseModelPromptTitle =>
      'Улучшить распознавание китайского';

  @override
  String get modernChineseModelPromptBody =>
      'Для этого документа на китайском сейчас не хватает современного детектора китайского языка (около 98 МБ). Прежняя многоязычная модель откалибрована на текстах ранних поколений и может пропускать современное китайское письмо в стиле DeepSeek, Gemini и GPT. Загрузите специализированную локальную модель, чтобы получить более точно откалиброванный результат, или продолжите с более слабым межъязыковым запасным вариантом.';

  @override
  String get onboardingWelcomeTitle => 'Добро пожаловать в OmniTrace';
  ...
  @override
  String get onboardingBundleTitle => 'Рекомендация для этого устройства';

  @override
  String onboardingBundleSummary(int count, String size) {
    return 'Моделей: $count · всего $size МБ';
  }

  @override
  String onboardingBundleStorage(String available, String remaining) {
    return 'Хранилище браузера: доступно $available МБ, после загрузки останется примерно $remaining МБ';
  }

  @override
  String get onboardingStorageNotPersisted =>
      'Загруженные модели пока не защищены от автоматической очистки. При нехватке места на диске браузер может их удалить, и загружать придётся заново. Если установить OmniTrace как приложение, вероятность того, что браузер их сохранит, значительно возрастает.';

  @override
  String get onboardingInstallAppButton => 'Установить как приложение';
  ...
  String reportEngineDirectionalIndex(int percent) {
    return 'Слабое направление $percent/100';
  }

  @override
  String get reportEngineNoDirectionalSignal =>
      'Направленный сигнал отсутствует';

  @override
  String get reportEngineExecutedNoStrongSignal =>
      'Выполнено, сильного сигнала нет';
  ...
  String get privacySealNoticeText =>
      'Знак 100% локальной конфиденциальности OmniTrace: Обработка на устройстве без сохранения в облаке.';
  ...
  @override
  String get ocrGeminiKeyRequired => 'Сначала введите ключ API Gemini.';

  @override
  String get ocrGeminiKeyValid => 'Ключ API Gemini действителен и доступен.';

  @override
  String get ocrGeminiKeyUnreachable =>
      'Не удалось связаться с API Gemini. Проверьте ключ.';

  @override
  String get ocrStatusLocalUnset => 'Локальный OCR: конечная точка не задана';

  @override
  String get ocrStatusLocalUntested =>
      'Локальный OCR: точка задана, не проверена';

  @override
  String get ocrStatusLocalTesting => 'Локальный OCR: проверка соединения';

  @override
  String get ocrStatusLocalReady => 'Локальный OCR: готов';

  @override
  String get ocrStatusLocalUnreachable => 'Локальный OCR: недоступен';

  @override
  String get ocrStatusGeminiUnset => 'Gemini: ключ не задан';

  @override
  String get ocrStatusGeminiUntested => 'Gemini: ключ задан, не проверен';

  @override
  String get ocrStatusGeminiVerifying => 'Gemini: проверка ключа';

  @override
  String get ocrStatusGeminiValid => 'Gemini: ключ действителен';

  @override
  String get ocrStatusGeminiInvalid => 'Gemini: недействителен или недоступен';

  @override
  String get ocrActiveLocalVerified =>
      'Активный движок: локальный сервер OCR (проверен)';

  @override
  String get ocrActiveLocalUntested =>
      'Активный движок: локальный сервер OCR (не проверен)';

  @override
  String get ocrActiveGeminiVerified =>
      'Активный движок: API Gemini (проверен)';

  @override
  String get ocrActiveGeminiUntested =>
      'Активный движок: API Gemini (не проверен)';

  @override
  String get ocrActiveNone => 'Движок OCR ещё не настроен';

  @override
  String get ocrDetectAndDownload => 'Определить систему и скачать установщик';

  @override
  String get ocrAutoInstallUnavailable => 'Автоматическая установка недоступна';

  @override
  String get ocrUnsupportedPlatformBody =>
      'Текущая платформа не поддерживает установку в один клик. Веб-браузер не может установить и запустить локальную службу OCR в iOS, Android, Linux или неизвестной системе.\n\nВарианты:\n1. Откройте этот мастер в настольном браузере macOS или Windows.\n2. Используйте ключ API Gemini как запасной вариант веб-OCR.\n3. Опытные пользователи могут открыть проект OCR, поднять совместимую конечную точку /ocr и указать её URL здесь.';

  @override
  String ocrInstallerReady(String osName) {
    return 'Установщик для $osName готов';
  }
  ...
  String get ocrRunInstructionWindows =>
      'дважды щёлкните setup_and_run_ocr.bat в папке «Загрузки»';
  ...
  String ocrAssistantDownloadedBody(
    ...
    return 'Обнаружена система $osName, локальная конечная точка заполнена автоматически:\n$endpoint\n\nБраузер начал загрузку $fileName. Из соображений безопасности OmniTrace Web не может сам запустить установщик или изменить параметры автозапуска.\n\nДальнейшие шаги:\n1. Запустите загруженный установщик: $runInstruction\n2. Дождитесь сообщения в терминале или окне о готовности службы OCR.\n3. Вернитесь сюда и выберите «$testButton».\n\nПосле успешной проверки OCR изображений будет использовать эту локальную службу. Изображения не отправляются в Gemini, если вы не настроите ключ API Gemini как запасной вариант.';
  }
  ...
  String get abstentionNoEvidenceFound =>
      'Все движки отработали, но ни один не нашёл пригодных доказательств. Низкая запасная оценка — это диагностический вывод, а не доказательство того, что текст написал человек.';

  @override
  String abstentionSingleWeakEvidenceSource(int count) {
    return 'Пригодные доказательства нашёл только $count движок, а общая оценка по-прежнему ниже порога ИИ. Считайте это слабым охватом, а не доказательством авторства человека.';
  }
  ...
  String reportBibUncertainNoReliableResponse(String base) {
    return '$base: источники проверки не дали надёжного ответа, или записи недостаточно информации; OmniTrace не считает эту цитату подтверждённой.';
  }
  ...
  @override
  String get exportReportTitle => 'Отчёт обнаружения OmniTrace';

  @override
  String pdfPageFooter(int page, int total) {
    return 'OmniTrace · Страница $page из $total';
  }
  ...
  String engineReasonBurstinessMid(String value) {
    return 'Разброс длины предложений (пачечность $value) остался в нейтральном диапазоне 0,30–0,55';
  }
  ...
  String engineReasonMattrNoAiSignal(String value, String cut) {
    return 'Лексическое разнообразие (MATTR $value) не превысило откалиброванный порог сигнала ИИ $cut';
  }
  ...
  String get modelNameTruthlensZh =>
      'Китайский детектор OmniTrace (генераторы 2026 · INT8)';
  ...
  String engineReasonPan25LexicalHuman(int percent) {
    return 'Лексический отпечаток PAN 2025 склоняется к человеку ($percent/100); это остаётся модельным свидетельством, а не доказательством авторства';
  }

  @override
  String engineReasonPan25LexicalNeutral(int percent) {
    return 'Лексический отпечаток PAN 2025 нейтрален ($percent/100) и не задаёт направления';
  }

  @override
  String engineReasonDetectRlZhAi(int percent) {
    return 'Отпечаток китайских символов DetectRL-ZH превысил консервативный порог доказательства ИИ ($percent/100); он независимо проверен на DeepSeek-V3, смешанных текстах, обратном переводе, возмущении символов и разной длине';
  }

  @override
  String engineReasonDetectRlZhNoAiSignal(int percent) {
    return 'Отпечаток китайских символов DetectRL-ZH не превысил консервативный порог доказательства ИИ ($percent/100); это воздержание, а не доказательство того, что текст написал человек';
  }

  @override
  String engineReasonCompressionCoherence(String value) {
    return 'Согласованность сжатия через границы ($value) превышает отсечку 95-го процентиля человеческих текстов PAN 2025 [слабый сигнал со стороны ИИ]';
  }

  @override
  String engineReasonAssistantResponseArtifact(int count) {
    return 'Обнаружено артефактов ответа диалогового ассистента: $count — например, обращение к заказчику или предложение доработать запрошенный текст';
  }
  ...
  String get helpVsGptZero1 =>
      'GPTZero выполняет основную работу в облаке и требует загрузки документа; все четыре движка OmniTrace работают в вашем собственном браузере, а содержимое никуда не отправляется.';

  @override
  String get helpVsGptZero2 =>
      'GPTZero стал пионером метрик Perplexity/Burstiness и выделения предложений — OmniTrace объединяет их и добавляет классификатор Transformer, стилометрический анализ и состязательную защиту, формируя ансамблевое голосование четырёх моделей вместо одной метрики.';

  @override
  String get helpVsGptZero3 =>
      'GPTZero работает по подписке; OmniTrace не требует подписки и не имеет ограничений использования.';
  ...
  String get helpVsTurnitin1 =>
      'Turnitin продаётся только учреждениям; частные лица не могут купить его напрямую. Любой может установить и использовать OmniTrace.';

  @override
  String get helpVsTurnitin2 =>
      'Процесс принятия решений Turnitin почти как чёрный ящик; OmniTrace предоставляет вероятность ИИ для каждого предложения, совпадающие шаблоны письма, а также разбивку баллов и причин по каждому модулю.';

  @override
  String get helpVsTurnitin3 =>
      'Turnitin в основном даёт бинарный результат «является ли это ИИ»; OmniTrace поддерживает маркировку человек/ИИ/смешанное на уровне абзаца/предложения.';
  ...
  String get helpVsOriginality1 =>
      'Originality.ai берёт плату за текст по подписке и требует загрузки в облако; OmniTrace выполняет основную работу в браузере — без подписки и без ограничений по числу проверок.';

  @override
  String get helpVsOriginality2 =>
      'Originality.ai предлагает концепции проверки фактов и анализа читабельности; OmniTrace отвечает на это модулем стилевых характеристик на устройстве и может выполнять базовый анализ даже офлайн.';
  ...
  String get helpVsWinston1 =>
      'OCR изображений у Winston AI отправляет картинку в облако; OCR в OmniTrace предпочитает локальный OCR-сервер, который вы настраиваете, и обращается к облаку только если вы сами укажете ключ Gemini API — участвует ли облако вообще, решаете вы.';

  @override
  String get helpVsWinston2 =>
      'Winston AI известен аккуратными, готовыми для печати отчётами; OmniTrace динамически создаёт макет отчёта с помощью ИИ (возвращаясь к шаблону, если LLM не установлена), с возможностью экспорта в PDF/CSV/JSON/PNG.';

  @override
  String get helpAdvantagesTitle => 'Эксклюзивные преимущества OmniTrace';
  ...
  String get helpWorkflowStep1Body =>
      'Приложение всегда открывается на главном экране. При первом запуске, если ни одна модель обнаружения ещё не установлена, появится запрос: хотите ли вы выбрать модель. Если отказаться, анализ можно начать сразу — его выполнят статистический и стилистический движки. Проверить, загрузить, обновить или удалить модели можно в любой момент через «Настройки → Управление моделями ИИ». При запуске приложение само проверяет наличие новой версии и отмечает значок настроек и пункт «Управление моделями ИИ», если доступно обновление.';
  ...
  String get helpWorkflowStep2Bullet1 =>
      'Многоязычный ИИ-классификатор (вес 40 %): анализирует ограниченные блоки абзацев, чтобы сохранить контекст, а затем переносит вероятности обратно на предложения для детальных доказательств. Если установлено несколько вариантов классификатора, для каждого анализа выбирается тот, который проверен для языка документа: китайским документам нужен отдельный современный детектор китайского, и приложение сообщает, когда этой модели нет.';
  ...
  String get privacyWebOverview1 =>
      'OmniTrace полностью работает как веб-приложение во вкладке вашего браузера. Ничего не нужно устанавливать; текст документа и результаты анализа никогда не покидают ваше устройство, а загруженные модели обнаружения кэшируются только в собственном изолированном хранилище браузера (OPFS), а не на сервере.';
  ...
  String get privacyIosOverview1 =>
      'OmniTrace не собирает никаких данных, связанных с вашей личностью, и не использует никакие данные для отслеживания, поэтому не требует разрешения App Tracking Transparency (ATT).';
  ...
  String get privacyAndroidOverview1 =>
      'OmniTrace не собирает личные данные и не передаёт данные пользователя каким-либо третьим лицам.';
  ...
  String get privacyMacosOverview1 =>
      'OmniTrace работает в App Sandbox macOS и может получать доступ только к файлам, которые вы активно выбираете через системный диалог файлов (files.user-selected.read-write) — оно не может самостоятельно просматривать или обращаться к каким-либо другим файлам или папкам.';
  ...
  String get privacyWindowsOverview1 =>
      'OmniTrace — это автономное настольное приложение; данные хранятся в вашей локальной папке пользователя (например, AppData/Documents) и никогда не синхронизируются с облаком.';
  ...
  String get privacyDataHandling1 =>
      'У OmniTrace нет учётных записей пользователей, не требуется вход в систему, и оно не содержит никаких рекламных или отслеживающих SDK третьих лиц в какой-либо форме.';

  @override
  String get privacyDataHandling2 =>
      'Любое содержимое документа, которое вы вводите, вставляете или импортируете, полностью анализируется моделями ИИ на вашем собственном устройстве — оно никогда не загружается на серверы OmniTrace или какие-либо серверы третьих лиц.';

  @override
  String get privacyDataHandling3 =>
      'Результаты анализа и история хранятся только в локальной базе данных на вашем устройстве; удаление приложения или очистка истории полностью удаляет их — OmniTrace не хранит никаких копий где-либо.';
  ...
  String get privacyDisclaimer =>
      'Эта страница представляет собой объяснение конфиденциальности, написанное OmniTrace для отражения фактического функционального поведения, а не формальный юридический документ, проверенный юристом; для формальной проверки соответствия законам вашего региона обратитесь к независимому юристу.';
  ...
  @override
  String get workspaceAiEvidenceIndexShort => 'индекс';
  ...
  String reportEngineRelationshipDirectionalOnly(String engine, int weight) {
    return '$engine обнаружил только слабый направленный сигнал. При скрининге он дисконтируется и не засчитывается как доказательство, прошедшее порог (предел веса роли $weight %).';
  }
  ...
  String get reportProvenanceContradictsLowScore =>
      'Собственная история правок файла противоречит этой низкой оценке. Свидетельства происхождения не слабеют по мере развития языковых моделей, тогда как текстовая статистика не распознаёт хорошо написанные тексты современных моделей. Сначала изучите свидетельства происхождения ниже, а затем делайте выводы из оценки выше.';
  ...
  String findingPublicationPredatesGenerativeAi(String doi, int year) {
    return 'Исходный DOI $doi соответствует этому документу и зарегистрирован в $year году — до появления современных генеративных систем письма на базе ИИ.';
  }

  @override
  String findingPublicationIdentityMismatch(String doi) {
    return 'Исходный DOI $doi разрешается, но зарегистрированное по нему название не совпадает с этим документом. Проверьте идентичность документа, прежде чем на него опираться.';
  }

  @override
  String get integratedStabilityUnavailable =>
      'Стабильность по сегментам недоступна · ни одно доказательство на уровне предложений не проголосовало';

  @override
  String get integratedNeutralBaseline =>
      'Не найдено характерных для авторства доказательств, достаточно сильных для повышения уровня. Показанный результат — лучший доступный направленный скрининг, а не утверждение, что доказательства ИИ и человека равны.';
  ...
  @override
  String get evidenceMatrixTitle => 'Оценка по нескольким видам доказательств';

  @override
  String get evidenceMatrixSubtitle =>
      'Шесть осей показаны отдельно. На вердикт влияют только характерные для авторства доказательства; охват показывает, что вообще удалось проверить.';

  @override
  String evidenceMatrixCoverage(int available, int total) {
    return 'Охват доказательств: $available из $total осей';
  }

  @override
  String get evidenceAxisText => 'Следы генерации текста';

  @override
  String get evidenceAxisTextNote =>
      'Вероятностные закономерности от четырёх локальных детекторов';

  @override
  String get evidenceAxisProcess => 'Процесс написания';

  @override
  String get evidenceAxisProcessNote =>
      'События набора, правки и вставки, зафиксированные без сохранения их содержимого';

  @override
  String get evidenceAxisOrigin => 'Происхождение документа';

  @override
  String get evidenceAxisOriginNote =>
      'Время редактирования, число сохранений и метаданные DOCX/ODT/RSID';

  @override
  String get evidenceAxisSources => 'Достоверность утверждений и источников';

  @override
  String get evidenceAxisSourcesNote =>
      'Проверяемые утверждения, привязки цитат и библиографическая сверка';

  @override
  String get evidenceStateUnavailable => 'Недоступно';

  @override
  String get evidenceStateInconclusive => 'Неоднозначно';

  @override
  String get evidenceStateReassuring => 'Согласуется';

  @override
  String get evidenceStateConcern => 'Проверить';

  @override
  String get evidenceStrengthNone => 'Доказательств нет';

  @override
  String get evidenceStrengthLimited => 'Ограниченные';

  @override
  String get evidenceStrengthModerate => 'Умеренные';

  @override
  String get evidenceStrengthStrong => 'Сильные';

  @override
  String get evidenceMatrixTextOnlyWarning =>
      'Доступна была только ось текстовых закономерностей. Современный ИИ умеет имитировать человеческую прозу, поэтому этот отчёт не может установить авторство по одной лишь оценке.';

  @override
  String get evidenceMatrixStrongConcern =>
      'По меньшей мере одна независимая ось содержит сильный сигнал к проверке. Изучите это доказательство, прежде чем полагаться на текстовую оценку.';

  @override
  String findingUnsupportedClaims(int unsupported, int total) {
    return '$unsupported из $total проверяемых утверждений содержат числа, сравнения или ссылки на исследования без привязки к источнику в том же предложении. Это не доказывает их ложность, но указывает, какие утверждения стоит проверить в первую очередь.';
  }

  @override
  String get integratedAssessmentTitle => 'Сводная оценка авторства';

  @override
  String get integratedInsufficientEvidence =>
      'Измеримый сигнал авторства отсутствует';

  @override
  String get integratedLikelyAi => 'Скорее сгенерировано ИИ';

  @override
  String get integratedLikelyMixed => 'Скорее смешанное: человек и ИИ';

  @override
  String get integratedLikelyHuman => 'Скорее не сгенерировано ИИ';

  @override
  String get integratedBalanced =>
      'Явного преобладания сигнала ИИ не обнаружено';

  @override
  String get integratedPreliminaryAi =>
      'Сейчас склоняется к ИИ, вблизи границы';

  @override
  String get integratedPreliminaryHuman =>
      'Сейчас склоняется к человеку, вблизи границы';

  @override
  String integratedLikelihoodLabel(int percent) {
    return 'Индекс доказательств ИИ: $percent/100';
  }

  @override
  String get integratedLikelihoodUnavailable =>
      'Индекс доказательств ИИ: оценить невозможно';

  @override
  String integratedTextScoreLabel(int percent) {
    return 'Оценка текстовой модели: $percent %';
  }
  ...
  @override
  String get integratedConfidenceLow => 'Низкая';

  @override
  String get integratedConfidenceModerate => 'Средняя';

  @override
  String get integratedConfidenceHigh => 'Высокая';
  ...
  @override
  String get integratedEvidenceTierReference => 'справочный уровень';

  @override
  String get integratedEvidenceTierStrong => 'хорошо обосновано';

  @override
  String integratedBoundaryAi(int index, int gap) {
    return 'Индекс $index — лишь слабое направление в сторону ИИ, он по-прежнему на $gap пунктов ниже линии повышения в 60 пунктов. Авторство ИИ не установлено.';
  }

  @override
  String integratedBoundaryHuman(int index, int gap) {
    return 'Индекс $index склоняется к человеку и по-прежнему на $gap пунктов ниже линии повышения ИИ в 60 пунктов, но ограниченные доказательства не позволяют исключить помощь ИИ.';
  }

  @override
  String integratedEvidenceCoverage(int families, int coverage) {
    return 'Семейства направленных сигналов: $families/4 · охват применимости $coverage %';
  }

  @override
  String get integratedEvidenceGatePassed => 'Порог доказательств ИИ: пройден';

  @override
  String get integratedEvidenceGateNotPassed =>
      'Порог доказательств ИИ: не пройден · только направленный скрининг';

  @override
  String integratedQualifiedWarning(String reason) {
    return '$reason Система по-прежнему указывает наиболее вероятное направление, но уверенность снижена; воспринимайте это как результат скрининга, а не доказательство.';
  }

  @override
  String get integratedIndexCaveat =>
      'Отдельный порог доказательств ИИ показывает, достаточно ли независимого подтверждения для повышения уровня. Качество цитирования, поведение при вставке и подозрительные метаданные сами по себе не могут дать вердикт об ИИ. Это оценка доказательности, а не откалиброванная статистическая вероятность.';

  @override
  String get reportTextEngineSignalExplanation =>
      'Эти полосы показывают диагностические сигналы четырёх текстовых движков. Родственные движки объединяются по семействам — включая консервативно дисконтированный вывод классификатора на стороне человека — прежде чем применяются языковая и доменная применимость и надёжность калибровки. Направление отвечает на вопрос, какое объяснение лучше подкреплено; отдельный порог доказательств ИИ отвечает, достаточно ли этого подкрепления для повышения уровня.';

  @override
  String reportSynthesisTextScoreContext(int percent) {
    return 'Исходная оценка текстовой модели по четырём движкам: $percent %. Это один из входов сводной оценки, а не второй вердикт.';
  }

  @override
  String reportSynthesisStrongestTextSignal(String label, int percent) {
    return 'Самый сильный сигнал текстовых движков: $label ($percent %). Он может влиять на оценку текстовой модели, но сам по себе не отменяет сводную оценку.';
  }
  ...
  String composerTextScoreThresholdReached(
    ...
    return 'Исходная оценка текстовой модели — $aiPercent %, она достигает диагностической отметки $thresholdPercent %. Это лишь наблюдение за текстовым сигналом; направление авторства в отчёте по-прежнему задаёт сводная оценка выше.';
  }
  ...
  String composerTextScoreThresholdNotReached(
    ...
    return 'Исходная оценка текстовой модели — $aiPercent %, что ниже диагностической отметки $thresholdPercent %. Недостижение этой отметки не является доказательством авторства человека; направление авторства в отчёте по-прежнему задаёт сводная оценка выше.';
  }
  ...
  String telemetryIntegratedVerdict(
    ...
    return 'После взвешивания доступных доказательств документ оценивается как «$direction» (индекс доказательств ИИ $percent/100, уверенность $confidence).';
  }

  @override
  String telemetryIntegratedUnavailable(String direction, String confidence) {
    return 'Доступные модули не дали измеримого направления авторства («$direction», уверенность $confidence); числовой индекс не выдан.';
  }

  @override
  String integratedStabilityLabel(int percent, int lower, int upper) {
    return 'Стабильность по сегментам $percent % · интервал $lower–$upper %';
  }

  @override
  String integratedInputQualityLabel(int percent) {
    return 'Качество извлечения входных данных: $percent %';
  }

  @override
  String integratedCalibrationLabel(String value, int count) {
    return 'Подходящая локальная база: p=$value · n=$count';
  }

  @override
  String analysisReadinessLabel(String level) {
    return 'Базовая уверенность до анализа: $level';
  }

  @override
  String get analysisReadinessShortText => 'нужно больше текста';

  @override
  String get analysisReadinessFewSentences => 'слишком мало сегментов';

  @override
  String get analysisReadinessCoreModel => 'основной классификатор недоступен';

  @override
  String get analysisReadinessFewEngines => 'включено менее двух движков';

  @override
  String get analysisReadinessExtraction => 'качество извлечения ограничено';

  @override
  String get analysisReadinessBaseline => 'подходящей локальной базы нет';

  @override
  String get ocrChipLocalVerified => 'Локальный OCR (проверен)';

  @override
  String get ocrChipLocalUntested => 'Локальный OCR (не проверен)';

  @override
  String get ocrChipGeminiVerified => 'Gemini (проверен)';

  @override
  String get ocrChipGeminiUntested => 'Gemini (не проверен)';

  @override
  String get ocrChipNone => 'Движок OCR: не настроен';

  @override
  String ocrErrorLocalServerReported(String detail) {
    return 'Локальный сервер OCR сообщил об ошибке: $detail';
  }

  @override
  String get ocrErrorLocalServerFormat =>
      'Локальный сервер OCR вернул несовместимый формат ответа; ожидался массив текстовых блоков, results[].text или text.';

  @override
  String get ocrErrorNoTextDetected =>
      'OCR завершён, но в изображении не найдено пригодного текста.';

  @override
  String ocrErrorLocalServerStatus(String status, String detail) {
    return 'Локальный сервер OCR вернул HTTP $status: $detail';
  }

  @override
  String ocrErrorLocalUnreachable(String detail) {
    return 'Не удалось связаться с локальным сервером OCR либо истекло время ожидания: $detail';
  }

  @override
  String get ocrErrorNotConfigured =>
      'OCR ещё не настроен. Укажите ключ API Gemini в настройках или адрес локального сервера OCR.';

  @override
  String get ocrErrorGeminiNoParsableText =>
      'Gemini ответил, но в ответе нет пригодного для разбора текста.';

  @override
  String get ocrErrorGeminiRateLimited =>
      'Gemini OCR достиг предела частоты или квоты (429). Повторите попытку позже или используйте локальный сервер OCR.';

  @override
  String ocrErrorGeminiBadRequest(String detail) {
    return 'Gemini OCR отклонил запрос (400): $detail';
  }

  @override
  String get ocrErrorGeminiUnauthorized =>
      'Ключ API Gemini недействителен или не авторизован (401). Вставьте действительный ключ ещё раз.';

  @override
  String ocrErrorGeminiHttpFailed(String status, String detail) {
    return 'Сбой Gemini OCR (HTTP $status): $detail';
  }

  @override
  String ocrErrorGeminiException(String detail) {
    return 'Gemini OCR не смог подключиться или разобрать ответ: $detail';
  }

  @override
  String get ocrErrorNoImageData =>
      'Данные изображения не получены. Выберите изображение заново; если ошибка повторяется, браузер, возможно, не передаёт байты файла.';

  @override
  String ocrErrorGeminiKeyInvalid(String status) {
    return 'Ключ API Gemini недействителен или не авторизован (HTTP $status).';
  }

  @override
  String ocrErrorGeminiTestFailed(String status) {
    return 'Проверка подключения к API Gemini не удалась (HTTP $status).';
  }

  @override
  String ocrErrorGeminiTestException(String detail) {
    return 'Проверка подключения к API Gemini не удалась: $detail';
  }

  @override
  String get ocrErrorNativePluginNoPing =>
      'Нативный плагин OCR на этой платформе не ответил на ping.';

  @override
  String get ocrErrorNativePluginMissing =>
      'На этой платформе не зарегистрирован нативный плагин OCR.';

  @override
  String ocrErrorNativeCheckFailed(String detail) {
    return 'Не удалось проверить нативный плагин OCR: $detail';
  }

  @override
  String ocrErrorNativeFailed(String detail) {
    return 'Сбой нативного OCR: $detail';
  }

  @override
  String get settingsEngineLlmTitle => 'LLM для составления отчётов';
  ...
  String get firstRunModelManualBody =>
      'Вы можете загрузить их в любой момент: откройте «Настройки» (значок шестерёнки на верхней панели) и выберите «Управление моделями ИИ». До этого OmniTrace продолжит работать со статистическим и стилистическим движками.';

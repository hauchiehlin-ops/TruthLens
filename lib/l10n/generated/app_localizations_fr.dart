...
class AppLocalizationsFr extends AppLocalizations {
  ...
  @override
  String get firstRunModelPromptTitle => 'Ajouter un modèle de détection ?';

  @override
  String get firstRunModelPromptBody =>
      'OmniTrace fonctionne déjà : les moteurs statistique et stylistique sont prêts. L\'ajout d\'un modèle neuronal local fait entrer le classificateur multilingue dans le vote d\'ensemble, ce qui améliore nettement la précision et la couverture linguistique. Le modèle s\'exécute entièrement dans votre navigateur et n\'envoie jamais vos documents. Vous pouvez aussi décider plus tard depuis « Paramètres → Gestion des modèles d\'IA ».';

  @override
  String get firstRunModelPromptLater => 'Pas maintenant';

  @override
  String get firstRunModelPromptGo => 'Choisir un modèle';

  @override
  String get modernChineseModelPromptTitle =>
      'Améliorer la détection du chinois';

  @override
  String get modernChineseModelPromptBody =>
      'Il manque actuellement à ce document chinois le détecteur chinois moderne (environ 98 Mo). L\'ancien modèle multilingue a été calibré sur des textes de première génération et peut passer à côté de l\'écriture chinoise actuelle de type DeepSeek, Gemini ou GPT. Téléchargez le modèle local spécialisé pour un résultat mieux calibré, ou continuez avec la solution de repli interlingue, plus faible.';

  @override
  String get onboardingWelcomeTitle => 'Bienvenue sur OmniTrace';
  ...
  @override
  String get onboardingBundleTitle => 'Recommandation pour cet appareil';

  @override
  String onboardingBundleSummary(int count, String size) {
    return '$count modèles · $size Mo au total';
  }

  @override
  String onboardingBundleStorage(String available, String remaining) {
    return 'Stockage du navigateur : $available Mo disponibles, environ $remaining Mo restants après le téléchargement';
  }

  @override
  String get onboardingStorageNotPersisted =>
      'Les modèles téléchargés ne sont pas encore protégés contre le nettoyage automatique. Si l\'espace disque vient à manquer, le navigateur peut les supprimer et vous devriez les retélécharger. Installer OmniTrace en tant qu\'application augmente fortement les chances que le navigateur les conserve.';

  @override
  String get onboardingInstallAppButton => 'Installer comme application';
  ...
  String reportEngineDirectionalIndex(int percent) {
    return 'Direction faible $percent/100';
  }
  ...
  String get privacySealNoticeText =>
      'Sceau de confidentialité OmniTrace Zero-Cloud : Traité 100% sur l\'appareil sans stockage cloud.';
  ...
  String get ocrGeminiKeyRequired =>
      'Saisissez d\'abord une clé d\'API Gemini.';

  @override
  String get ocrGeminiKeyValid =>
      'La clé d\'API Gemini est valide et accessible.';

  @override
  String get ocrGeminiKeyUnreachable =>
      'Impossible de joindre l\'API Gemini. Vérifiez la clé.';

  @override
  String get ocrStatusLocalUnset =>
      'OCR local : point de terminaison non défini';

  @override
  String get ocrStatusLocalUntested =>
      'OCR local : point de terminaison défini, non testé';

  @override
  String get ocrStatusLocalTesting => 'OCR local : test de la connexion';

  @override
  String get ocrStatusLocalReady => 'OCR local : prêt';

  @override
  String get ocrStatusLocalUnreachable => 'OCR local : inaccessible';

  @override
  String get ocrStatusGeminiUnset => 'Gemini : aucune clé définie';

  @override
  String get ocrStatusGeminiUntested => 'Gemini : clé définie, non testée';

  @override
  String get ocrStatusGeminiVerifying => 'Gemini : vérification de la clé';

  @override
  String get ocrStatusGeminiValid => 'Gemini : clé valide';

  @override
  String get ocrStatusGeminiInvalid => 'Gemini : non valide ou inaccessible';

  @override
  String get ocrActiveLocalVerified =>
      'Moteur actif : serveur OCR local (vérifié)';

  @override
  String get ocrActiveLocalUntested =>
      'Moteur actif : serveur OCR local (non testé)';

  @override
  String get ocrActiveGeminiVerified => 'Moteur actif : API Gemini (vérifié)';

  @override
  String get ocrActiveGeminiUntested => 'Moteur actif : API Gemini (non testé)';

  @override
  String get ocrActiveNone => 'Aucun moteur OCR configuré';

  @override
  String get ocrDetectAndDownload =>
      'Détecter le système et télécharger l\'installateur';
  ...
  String get ocrUnsupportedPlatformBody =>
      'La plateforme actuelle ne prend pas en charge l\'installation de bureau en un clic. Un navigateur web ne peut pas installer ni démarrer un service OCR local sous iOS, Android, Linux ou un système inconnu.\n\nSolutions :\n1. Utilisez cet assistant depuis un navigateur de bureau macOS ou Windows.\n2. Utilisez une clé d\'API Gemini comme solution de repli.\n3. Les utilisateurs avancés peuvent ouvrir le projet OCR, déployer un point de terminaison /ocr compatible, puis saisir l\'URL ici.';

  @override
  String ocrInstallerReady(String osName) {
    return 'L\'installateur $osName est prêt';
  }
  ...
  String get ocrRunInstructionWindows =>
      'double-cliquez sur setup_and_run_ocr.bat dans Téléchargements';
  ...
  String ocrAssistantDownloadedBody(
    ...
    return '$osName a été détecté et le point de terminaison local a été renseigné automatiquement :\n$endpoint\n\nVotre navigateur a commencé à télécharger $fileName. Pour des raisons de sécurité, OmniTrace Web ne peut pas exécuter l\'installateur ni modifier les réglages de démarrage.\n\nÉtapes suivantes :\n1. Exécutez l\'installateur téléchargé : $runInstruction\n2. Attendez que le terminal ou la fenêtre indique que le service OCR est prêt.\n3. Revenez ici et sélectionnez « $testButton ».\n\nUne fois le test réussi, l\'OCR d\'images utilisera d\'abord ce service local. Les images ne seront pas envoyées à Gemini, sauf si vous configurez également une clé d\'API Gemini en secours.';
  }
  ...
  String get abstentionNoEvidenceFound =>
      'Tous les moteurs ont été exécutés, mais aucun n\'a trouvé de preuve exploitable. Le score de repli bas est une sortie de diagnostic, non la preuve qu\'une personne a écrit le texte.';

  @override
  String abstentionSingleWeakEvidenceSource(int count) {
    return 'Seul $count moteur a trouvé une preuve exploitable, et le score global reste sous le seuil d\'IA. Considérez cela comme une couverture faible, non comme la preuve d\'une rédaction humaine.';
  }
  ...
  String reportBibUncertainNoReliableResponse(String base) {
    return '$base : les sources de vérification n\'ont renvoyé aucune réponse fiable ou l\'entrée manque d\'informations suffisantes ; OmniTrace ne considère pas cette citation comme vérifiée.';
  }
  ...
  @override
  String get exportReportTitle => 'Rapport de détection OmniTrace';

  @override
  String pdfPageFooter(int page, int total) {
    return 'OmniTrace · Page $page / $total';
  }
  ...
  String engineReasonBurstinessMid(String value) {
    return 'La variation de longueur des phrases (burstiness $value) est restée dans la bande neutre 0,30–0,55';
  }
  ...
  String engineReasonMattrNoAiSignal(String value, String cut) {
    return 'La diversité lexicale (MATTR $value) n\'a pas franchi le seuil calibré de signal d\'IA $cut';
  }
  ...
  String get modelNameTruthlensZh =>
      'Détecteur chinois OmniTrace (générateurs 2026 · INT8)';
  ...
  String engineReasonPan25LexicalHuman(int percent) {
    return 'L\'empreinte lexicale PAN 2025 penche vers l\'humain ($percent/100) ; cela reste une preuve issue d\'un modèle, non une preuve de paternité';
  }

  @override
  String engineReasonPan25LexicalNeutral(int percent) {
    return 'L\'empreinte lexicale PAN 2025 est neutre ($percent/100) et n\'indique aucune direction';
  }

  @override
  String engineReasonDetectRlZhAi(int percent) {
    return 'L\'empreinte de caractères chinois de DetectRL-ZH a franchi le seuil conservateur de preuve d\'IA ($percent/100) ; elle a été testée indépendamment face à DeepSeek-V3, aux textes mixtes, à la rétrotraduction, à la perturbation de caractères et à des longueurs variables';
  }

  @override
  String engineReasonDetectRlZhNoAiSignal(int percent) {
    return 'L\'empreinte de caractères chinois de DetectRL-ZH n\'a pas franchi le seuil conservateur de preuve d\'IA ($percent/100) ; il s\'agit d\'une abstention, non d\'une preuve qu\'un humain a écrit le texte';
  }

  @override
  String engineReasonCompressionCoherence(String value) {
    return 'La cohérence de compression entre frontières ($value) dépasse le filtre du 95e centile humain de PAN 2025 [signal faible du côté IA]';
  }

  @override
  String engineReasonAssistantResponseArtifact(int count) {
    return '$count artefact(s) de réponse d\'assistant conversationnel détecté(s), comme s\'adresser au demandeur ou proposer de retravailler le texte demandé';
  }
  ...
  @override
  String get helpAboutTitle => 'À propos de OmniTrace';
  ...
  String get helpVsGptZero1 =>
      'GPTZero effectue l\'essentiel du travail dans le cloud et exige l\'envoi du document ; les quatre moteurs de OmniTrace s\'exécutent dans votre propre navigateur et le contenu n\'est envoyé nulle part.';

  @override
  String get helpVsGptZero2 =>
      'GPTZero a été pionnier des métriques Perplexity/Burstiness et de la mise en surbrillance des phrases — OmniTrace les combine et ajoute un classificateur Transformer, une analyse stylométrique et une défense adversariale, formant un vote d\'ensemble à quatre modèles plutôt qu\'une seule métrique.';

  @override
  String get helpVsGptZero3 =>
      'GPTZero fonctionne par abonnement ; OmniTrace ne nécessite aucun abonnement et n\'a aucune limite d\'utilisation.';
  ...
  String get helpVsTurnitin1 =>
      'Turnitin est vendu uniquement aux institutions ; les particuliers ne peuvent pas l\'acheter directement. N\'importe qui peut installer et utiliser OmniTrace.';

  @override
  String get helpVsTurnitin2 =>
      'Le processus de décision de Turnitin est presque une boîte noire ; OmniTrace fournit la probabilité IA de chaque phrase, les motifs d\'écriture correspondants, ainsi que la répartition des scores et des raisons de chaque moteur.';

  @override
  String get helpVsTurnitin3 =>
      'Turnitin fournit principalement un résultat binaire \"est-ce de l\'IA\" ; OmniTrace prend en charge l\'étiquetage humain/IA/mixte au niveau du paragraphe/de la phrase.';
  ...
  String get helpVsOriginality1 =>
      'Originality.ai facture à la pièce sur abonnement et exige un envoi vers le cloud ; OmniTrace réalise l\'essentiel dans le navigateur, sans abonnement ni limite d\'usage.';

  @override
  String get helpVsOriginality2 =>
      'Originality.ai propose des concepts de vérification des faits et d\'analyse de lisibilité ; OmniTrace y répond avec un module de caractéristiques stylistiques sur l\'appareil, et peut effectuer une analyse de base même hors ligne.';
  ...
  String get helpVsWinston1 =>
      'L\'OCR d\'images de Winston AI envoie la photo dans le cloud ; l\'OCR de OmniTrace privilégie un serveur local que vous configurez et ne bascule vers le cloud que si vous fournissez vous-même une clé d\'API Gemini — recourir ou non au cloud reste votre décision.';

  @override
  String get helpVsWinston2 =>
      'Winston AI est connu pour ses rapports soignés et imprimables ; OmniTrace génère dynamiquement la mise en page du rapport via IA (revenant à un modèle si aucun LLM n\'est installé), exportable en PDF/CSV/JSON/PNG.';

  @override
  String get helpAdvantagesTitle => 'Avantages exclusifs de OmniTrace';
  ...
  String get helpWorkflowStep1Body =>
      'L\'application s\'ouvre toujours sur l\'écran principal. Au premier lancement, si aucun modèle de détection n\'est encore installé, une invite demande si vous souhaitez en choisir un — en la refusant, vous pouvez analyser immédiatement avec les moteurs statistique et stylistique. Vous pouvez à tout moment consulter, télécharger, mettre à jour ou supprimer des modèles depuis « Paramètres → Gestion des modèles d\'IA ». L\'application recherche activement la dernière version au démarrage et affiche un badge sur l\'icône des paramètres et sur l\'entrée « Gestion des modèles d\'IA » lorsqu\'une mise à jour est disponible.';
  ...
  String get helpWorkflowStep2Bullet1 =>
      'Classificateur d\'IA multilingue (pondération 40 %) : analyse des blocs de paragraphes délimités afin de préserver le contexte, puis reporte les probabilités sur chaque phrase pour fournir des preuves détaillées. Lorsque plusieurs variantes de classificateur sont installées, chaque analyse retient celle qui est validée pour la langue du document — les documents en chinois nécessitent le détecteur chinois moderne dédié, et l\'application le signale lorsque ce modèle est absent.';
  ...
  String get privacyIosOverview1 =>
      'OmniTrace ne collecte aucune donnée associée à votre identité et n\'utilise aucune donnée à des fins de suivi, ce qui ne nécessite donc pas d\'autorisation de transparence du suivi des applications (ATT).';
  ...
  String get privacyAndroidOverview1 =>
      'OmniTrace ne collecte aucune donnée personnelle et ne partage aucune donnée utilisateur avec des tiers.';
  ...
  String get privacyMacosOverview1 =>
      'OmniTrace s\'exécute sous le bac à sable des applications macOS et ne peut accéder qu\'aux fichiers que vous sélectionnez activement via la boîte de dialogue de fichiers du système (files.user-selected.read-write) — elle ne peut pas parcourir ni accéder à d\'autres fichiers ou dossiers par elle-même.';
  ...
  String get privacyWindowsOverview1 =>
      'OmniTrace est une application de bureau autonome ; les données sont stockées dans votre dossier utilisateur local (par ex. AppData/Documents) et ne sont jamais synchronisées avec le cloud.';
  ...
  String get privacyDataHandling1 =>
      'OmniTrace n\'a pas de comptes utilisateur, ne nécessite pas de connexion et ne contient aucun SDK publicitaire ou de suivi tiers sous quelque forme que ce soit.';

  @override
  String get privacyDataHandling2 =>
      'Tout contenu de document que vous saisissez, collez ou importez est entièrement analysé par des modèles IA sur votre propre appareil ; il n\'est jamais téléchargé vers OmniTrace ou tout serveur tiers.';

  @override
  String get privacyDataHandling3 =>
      'Les résultats d\'analyse et l\'historique ne sont stockés que dans une base de données locale sur votre appareil ; désinstaller l\'application ou effacer l\'historique les supprime complètement — OmniTrace ne conserve aucune copie où que ce soit.';
  ...
  String get privacyDisclaimer =>
      'Cette page est une explication de confidentialité rédigée par OmniTrace pour refléter le comportement fonctionnel réel, et non un document juridique formel révisé par un avocat ; pour un examen de conformité formel selon les lois de votre région, veuillez consulter un avocat indépendant.';
  ...
  @override
  String get workspaceAiEvidenceIndexShort => 'indice';
  ...
  String reportEngineRelationshipDirectionalOnly(String engine, int weight) {
    return '$engine n\'a trouvé qu\'un signal directionnel faible. Il est décoté pour le criblage et ne compte pas comme preuve qualifiée par seuil (plafond de pondération du rôle $weight %).';
  }
  ...
  String findingPublicationPredatesGenerativeAi(String doi, int year) {
    return 'Le DOI source $doi correspond à ce document et a été enregistré en $year, avant les systèmes modernes d\'écriture par IA générative.';
  }

  @override
  String findingPublicationIdentityMismatch(String doi) {
    return 'Le DOI source $doi se résout, mais son titre enregistré ne correspond pas à ce document. Vérifiez l\'identité du document avant de vous y fier.';
  }

  @override
  String get integratedStabilityUnavailable =>
      'Stabilité par segment indisponible · aucune preuve au niveau de la phrase n\'a voté';

  @override
  String get integratedNeutralBaseline =>
      'Aucune preuve propre à la paternité suffisamment forte pour une remontée n\'a été trouvée. Le résultat affiché est le meilleur criblage directionnel disponible, et non l\'affirmation que les preuves IA et humaines s\'équilibrent.';
  ...
  @override
  String get evidenceMatrixTitle => 'Évaluation multi-preuves';

  @override
  String get evidenceMatrixSubtitle =>
      'Six axes sont présentés séparément. Seules les preuves propres à la paternité influent sur le verdict ; la couverture indique ce qui a pu être examiné.';

  @override
  String evidenceMatrixCoverage(int available, int total) {
    return 'Couverture des preuves : $available axes sur $total';
  }

  @override
  String get evidenceAxisText => 'Traces de génération de texte';

  @override
  String get evidenceAxisTextNote =>
      'Motifs probabilistes issus des quatre détecteurs locaux';

  @override
  String get evidenceAxisProcess => 'Processus d\'écriture';

  @override
  String get evidenceAxisProcessNote =>
      'Événements de frappe, de révision et de collage enregistrés sans conserver leur contenu';

  @override
  String get evidenceAxisOrigin => 'Origine du document';

  @override
  String get evidenceAxisOriginNote =>
      'Temps d\'édition, enregistrements et métadonnées DOCX/ODT/RSID';

  @override
  String get evidenceAxisSources => 'Intégrité des affirmations et des sources';

  @override
  String get evidenceAxisSourcesNote =>
      'Affirmations vérifiables, ancres de citation et vérification bibliographique';

  @override
  String get evidenceStateUnavailable => 'Indisponible';

  @override
  String get evidenceStateInconclusive => 'Non concluant';

  @override
  String get evidenceStateReassuring => 'Cohérent';

  @override
  String get evidenceStateConcern => 'À examiner';

  @override
  String get evidenceStrengthNone => 'Aucune preuve';

  @override
  String get evidenceStrengthLimited => 'Limitée';

  @override
  String get evidenceStrengthModerate => 'Modérée';
  ...
  String get evidenceMatrixTextOnlyWarning =>
      'Seul l\'axe des motifs textuels était disponible. L\'IA actuelle sait imiter la prose humaine : ce rapport ne peut donc pas établir la paternité à partir du seul score.';

  @override
  String get evidenceMatrixStrongConcern =>
      'Au moins un axe indépendant contient un signal fort appelant un examen. Examinez cette preuve avant de vous fier au score textuel.';

  @override
  String findingUnsupportedClaims(int unsupported, int total) {
    return '$unsupported affirmations vérifiables sur $total contiennent des chiffres, des comparaisons ou des attributions à des travaux de recherche sans ancre de source dans la même phrase. Cela ne prouve pas qu\'elles soient fausses, mais identifie celles à vérifier en priorité.';
  }

  @override
  String get integratedAssessmentTitle => 'Évaluation intégrée de la paternité';

  @override
  String get integratedInsufficientEvidence =>
      'Aucun signal de paternité quantifiable';

  @override
  String get integratedLikelyAi => 'Plus probablement généré par IA';

  @override
  String get integratedLikelyMixed => 'Plus probablement mixte humain-IA';

  @override
  String get integratedLikelyHuman => 'Plus probablement non généré par IA';

  @override
  String get integratedBalanced =>
      'Aucun signal nettement dominé par l\'IA détecté';

  @override
  String get integratedPreliminaryAi =>
      'Penche actuellement vers l\'IA, près de la limite';

  @override
  String get integratedPreliminaryHuman =>
      'Penche actuellement vers l\'humain, près de la limite';

  @override
  String integratedLikelihoodLabel(int percent) {
    return 'Indice de preuve d\'IA : $percent/100';
  }

  @override
  String get integratedLikelihoodUnavailable =>
      'Indice de preuve d\'IA : non estimable';

  @override
  String integratedTextScoreLabel(int percent) {
    return 'Score du modèle textuel : $percent %';
  }
  ...
  @override
  String get integratedConfidenceLow => 'Faible';

  @override
  String get integratedConfidenceModerate => 'Modérée';

  @override
  String get integratedConfidenceHigh => 'Élevée';
  ...
  @override
  String get integratedEvidenceTierReference => 'utilisable comme référence';

  @override
  String get integratedEvidenceTierStrong => 'bien étayé';

  @override
  String integratedBoundaryAi(int index, int gap) {
    return 'L\'indice $index n\'est qu\'une faible orientation du côté IA et reste $gap points sous la ligne de remontée de 60 points. Il n\'établit pas une paternité par IA.';
  }

  @override
  String integratedBoundaryHuman(int index, int gap) {
    return 'L\'indice $index penche vers l\'humain et reste $gap points sous la ligne de remontée IA de 60 points, mais les preuves limitées ne permettent pas d\'exclure une assistance par IA.';
  }

  @override
  String integratedEvidenceCoverage(int families, int coverage) {
    return 'Familles de signaux directionnels : $families/4 · couverture d\'applicabilité $coverage %';
  }

  @override
  String get integratedEvidenceGatePassed => 'Seuil de preuve d\'IA : franchi';

  @override
  String get integratedEvidenceGateNotPassed =>
      'Seuil de preuve d\'IA : non franchi · criblage directionnel uniquement';

  @override
  String integratedQualifiedWarning(String reason) {
    return '$reason Le système indique toujours la direction la plus probable, mais avec une confiance réduite ; traitez-la comme un résultat de criblage, non comme une preuve.';
  }

  @override
  String get integratedIndexCaveat =>
      'Le seuil de preuve d\'IA, distinct, indique si le soutien indépendant est assez fort pour une remontée. La qualité des citations, le comportement de collage et des métadonnées suspectes ne peuvent à eux seuls produire un verdict d\'IA. Il s\'agit d\'un score de preuve, non d\'une probabilité statistique calibrée.';

  @override
  String get reportTextEngineSignalExplanation =>
      'Ces barres montrent les signaux de diagnostic des quatre moteurs textuels. Les moteurs apparentés sont fusionnés par famille — y compris la sortie du classificateur côté humain, décotée de façon conservatrice — avant l\'application de l\'applicabilité langue/domaine et de la fiabilité de calibrage. La direction répond à la question de savoir quelle explication est la mieux étayée ; le seuil de preuve d\'IA, distinct, répond à celle de savoir si l\'étayage suffit pour une remontée.';

  @override
  String reportSynthesisTextScoreContext(int percent) {
    return 'Score brut du modèle textuel à quatre moteurs : $percent %. C\'est une entrée de l\'évaluation intégrée, non un second verdict.';
  }

  @override
  String reportSynthesisStrongestTextSignal(String label, int percent) {
    return 'Signal le plus fort des moteurs textuels : $label ($percent %). Il peut influencer le score du modèle textuel, mais ne peut pas à lui seul l\'emporter sur l\'évaluation intégrée.';
  }
  ...
  String composerTextScoreThresholdReached(
    ...
    return 'Le score brut du modèle textuel est de $aiPercent %, atteignant le repère diagnostique de $thresholdPercent %. Il s\'agit uniquement d\'une observation du signal textuel ; l\'évaluation intégrée ci-dessus reste la direction de paternité du rapport.';
  }
  ...
  String composerTextScoreThresholdNotReached(
    ...
    return 'Le score brut du modèle textuel est de $aiPercent %, sous le repère diagnostique de $thresholdPercent %. Ne pas atteindre ce repère n\'est pas une preuve de rédaction humaine ; l\'évaluation intégrée ci-dessus reste la direction de paternité du rapport.';
  }
  ...
  String telemetryIntegratedVerdict(
    ...
    return 'Après pondération des preuves disponibles, le document est « $direction » (indice de preuve d\'IA $percent/100, confiance $confidence).';
  }

  @override
  String telemetryIntegratedUnavailable(String direction, String confidence) {
    return 'Les modules disponibles n\'ont pas produit de direction de paternité quantifiable (« $direction », confiance $confidence) ; aucun indice numérique n\'a été émis.';
  }

  @override
  String integratedStabilityLabel(int percent, int lower, int upper) {
    return 'Stabilité par segment $percent % · intervalle $lower–$upper %';
  }

  @override
  String integratedInputQualityLabel(int percent) {
    return 'Qualité d\'extraction de l\'entrée : $percent %';
  }

  @override
  String integratedCalibrationLabel(String value, int count) {
    return 'Référence locale correspondante : p=$value · n=$count';
  }

  @override
  String analysisReadinessLabel(String level) {
    return 'Base de confiance avant analyse : $level';
  }

  @override
  String get analysisReadinessShortText => 'davantage de texte nécessaire';

  @override
  String get analysisReadinessFewSentences => 'trop peu de segments';

  @override
  String get analysisReadinessCoreModel =>
      'classificateur principal indisponible';

  @override
  String get analysisReadinessFewEngines => 'moins de deux moteurs activés';

  @override
  String get analysisReadinessExtraction =>
      'la qualité d\'extraction est limitée';

  @override
  String get analysisReadinessBaseline =>
      'aucune référence locale correspondante';

  @override
  String get ocrChipLocalVerified => 'OCR local (vérifié)';

  @override
  String get ocrChipLocalUntested => 'OCR local (non testé)';

  @override
  String get ocrChipGeminiVerified => 'Gemini (vérifié)';

  @override
  String get ocrChipGeminiUntested => 'Gemini (non testé)';

  @override
  String get ocrChipNone => 'Moteur OCR : non configuré';

  @override
  String ocrErrorLocalServerReported(String detail) {
    return 'Le serveur OCR local a signalé une erreur : $detail';
  }

  @override
  String get ocrErrorLocalServerFormat =>
      'Le serveur OCR local a renvoyé un format de réponse incompatible ; un tableau de blocs de texte, results[].text ou text était attendu.';

  @override
  String get ocrErrorNoTextDetected =>
      'L\'OCR est terminé, mais aucun texte exploitable n\'a été trouvé dans l\'image.';

  @override
  String ocrErrorLocalServerStatus(String status, String detail) {
    return 'Le serveur OCR local a répondu HTTP $status : $detail';
  }

  @override
  String ocrErrorLocalUnreachable(String detail) {
    return 'Impossible de joindre le serveur OCR local, ou la requête a expiré : $detail';
  }

  @override
  String get ocrErrorNotConfigured =>
      'L\'OCR n\'est pas encore configuré. Ajoutez une clé d\'API Gemini dans les réglages, ou indiquez l\'URL d\'un serveur OCR local.';

  @override
  String get ocrErrorGeminiNoParsableText =>
      'Gemini a répondu, mais la réponse ne contenait aucun texte exploitable.';

  @override
  String get ocrErrorGeminiRateLimited =>
      'Gemini OCR a atteint une limite de débit ou de quota (429). Réessayez plus tard ou passez à un serveur OCR local.';

  @override
  String ocrErrorGeminiBadRequest(String detail) {
    return 'Gemini OCR a rejeté la requête (400) : $detail';
  }

  @override
  String get ocrErrorGeminiUnauthorized =>
      'La clé d\'API Gemini est invalide ou non autorisée (401). Veuillez recoller une clé valide.';

  @override
  String ocrErrorGeminiHttpFailed(String status, String detail) {
    return 'Échec de Gemini OCR (HTTP $status) : $detail';
  }

  @override
  String ocrErrorGeminiException(String detail) {
    return 'Gemini OCR n’a pas pu se connecter ou analyser la réponse : $detail';
  }

  @override
  String get ocrErrorNoImageData =>
      'Aucune donnée d\'image n\'a été reçue. Sélectionnez à nouveau l\'image ; si l\'échec persiste, le navigateur ne fournit peut-être pas les octets du fichier.';

  @override
  String ocrErrorGeminiKeyInvalid(String status) {
    return 'La clé d\'API Gemini est invalide ou non autorisée (HTTP $status).';
  }

  @override
  String ocrErrorGeminiTestFailed(String status) {
    return 'Échec du test de connexion à l\'API Gemini (HTTP $status).';
  }

  @override
  String ocrErrorGeminiTestException(String detail) {
    return 'Échec du test de connexion à l\'API Gemini : $detail';
  }

  @override
  String get ocrErrorNativePluginNoPing =>
      'Le plug-in OCR natif de cette plateforme n\'a pas répondu au ping.';

  @override
  String get ocrErrorNativePluginMissing =>
      'Aucun plug-in OCR natif n\'est enregistré sur cette plateforme.';

  @override
  String ocrErrorNativeCheckFailed(String detail) {
    return 'Échec de la vérification du plug-in OCR natif : $detail';
  }

  @override
  String ocrErrorNativeFailed(String detail) {
    return 'Échec de l’OCR natif : $detail';
  }

  @override
  String get settingsEngineLlmTitle => 'LLM de rédaction de rapports';

  @override
  String get modelNameGemma2Llm => 'Gemma 2 · 2B Instruct (Q4_K_M)';

  @override
  String get firstRunModelListTitle => 'Modèles à télécharger';

  @override
  String get firstRunModelOptionalReason =>
      'Facultatif — n’influe que sur la rédaction du rapport, pas sur le résultat de l’analyse';

  @override
  String get firstRunModelStorageReason =>
      'Risque de ne pas tenir dans l’espace de stockage disponible du navigateur';

  @override
  String firstRunModelRamReason(String ramGb) {
    return 'Nécessite $ramGb Go de RAM, soit plus que ce que signale cet appareil';
  }

  @override
  String firstRunModelSelectionSummary(int count, String size) {
    return '$count sélectionné(s) · $size au total';
  }

  @override
  String get firstRunModelConfirm => 'Télécharger la sélection';

  @override
  String get firstRunModelCancel => 'Annuler';

  @override
  String get firstRunModelManualTitle => 'Télécharger les modèles plus tard';

  @override
  String get firstRunModelManualBody =>
      'Vous pouvez les télécharger à tout moment : ouvrez les Réglages (icône d’engrenage dans la barre supérieure) et choisissez « Gestion des modèles IA ». D’ici là, OmniTrace continue de fonctionner avec ses moteurs statistique et stylistique.';

  @override
  String get commonGotIt => 'J’ai compris';

  @override
  String get publicGuideMenuTitle => 'Outils et guides publics';

  @override
  String get publicGuideFreeDetector => 'Détecteur gratuit de texte court';

  @override
  String get publicGuideZhDetector => 'Détecteur chinois traditionnel';

  @override
  String get publicGuideLocalVsCloud =>
      'Détection IA locale ou envoi vers le cloud';

  @override
  String get publicGuidePdfLimits => 'Limites de la détection IA sur PDF';

  @override
  String get publicGuideDocxEvidence => 'Historique DOCX comme indice';

  @override
  String get publicGuideLowBurstiness => 'Faible burstiness dans l’écriture IA';

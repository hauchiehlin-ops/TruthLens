...
class AppLocalizationsTh extends AppLocalizations {
  ...
  String get provenanceHowToGetRecord =>
      'หากต้องการให้หลักฐานที่มาใช้ได้จริง โปรดเก็บ **ไฟล์ต้นฉบับ .docx หรือ .odt** จากนักเรียน ไม่ใช่ PDF ที่พิมพ์หรือส่งออก เพราะมีเพียงไฟล์ต้นฉบับที่ยังเก็บประวัติการแก้ไขไว้ และมีเพียงไฟล์นั้นที่จะเข้าชุดฐานเทียบซึ่งมีการรับประกันทางสถิติได้โดยอัตโนมัติ';

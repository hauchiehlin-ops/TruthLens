...
class AppLocalizationsTh extends AppLocalizations {
  ...
  String get modelNecessityText =>
      'หากไม่ได้ดาวน์โหลดโมเดลตรวจจับแบบโครงข่ายประสาทเทียม OmniTrace ยังคงทำงานได้ แต่จะใช้เพียงการวิเคราะห์เชิงสถิติและรูปแบบการเขียนเท่านั้น ซึ่งมีความแม่นยำและการรองรับหลายภาษาที่จำกัด หลังจากดาวน์โหลดโมเดลแล้ว ตัวจำแนก Transformer หลายภาษาจะเข้าร่วมการโหวตแบบรวมกลุ่ม ซึ่งจะเพิ่มความแม่นยำและความน่าเชื่อถือของการตัดสินอย่างมาก โมเดลทำงานบนอุปกรณ์ของคุณ และหลังจากดาวน์โหลดแล้วจะไม่มีการอัปโหลดเนื้อหาใดๆ';
  ...
  String get firstRunModelPromptBody =>
      'OmniTrace ใช้งานได้อยู่แล้ว เอนจินเชิงสถิติและเชิงลีลาการเขียนพร้อมใช้งานทันที การเพิ่มโมเดลนิวรัลที่ทำงานบนเครื่องจะทำให้ตัวจำแนกหลายภาษาเข้าร่วมการโหวตแบบรวมกลุ่ม ซึ่งช่วยเพิ่มความแม่นยำและความครอบคลุมภาษาอย่างชัดเจน โมเดลทำงานภายในเบราว์เซอร์ของคุณทั้งหมดและไม่เคยอัปโหลดเอกสารของคุณ คุณเลือกภายหลังได้จาก \"การตั้งค่า → การจัดการโมเดล AI\"';
  ...
  @override
  String get onboardingWelcomeTitle => 'ยินดีต้อนรับสู่ OmniTrace';
  ...
  String get onboardingStorageNotPersisted =>
      'โมเดลที่ดาวน์โหลดแล้วยังไม่ได้รับการป้องกันจากการล้างข้อมูลอัตโนมัติ หากพื้นที่ดิสก์เหลือน้อย เบราว์เซอร์อาจเรียกคืนพื้นที่และคุณจะต้องดาวน์โหลดใหม่ การติดตั้ง OmniTrace เป็นแอปจะเพิ่มโอกาสที่เบราว์เซอร์จะเก็บโมเดลไว้อย่างมาก';
  ...
  String get privacySealNoticeText =>
      'ตราประทับความเป็นส่วนตัว 100% บนเครื่อง OmniTrace: ประมวลผลบนอุปกรณ์โดยไม่มีการบันทึกบนคลาวด์';
  ...
  String reportBibUncertainNoReliableResponse(String base) {
    return '$base: แหล่งตรวจสอบไม่ให้การตอบสนองที่น่าเชื่อถือ หรือรายการมีข้อมูลไม่เพียงพอ OmniTrace จึงไม่ถือว่าการอ้างอิงนี้ได้รับการยืนยัน';
  }
  ...
  @override
  String get exportReportTitle => 'รายงานการตรวจจับ OmniTrace';

  @override
  String pdfPageFooter(int page, int total) {
    return 'OmniTrace · หน้า $page / $total';
  }
  ...
  String get modelNameTruthlensZh =>
      'ตัวตรวจจับภาษาจีน OmniTrace (รุ่นปี 2026 · INT8)';
  ...
  String get helpVsGptZero1 =>
      'GPTZero ประมวลผลส่วนใหญ่บนคลาวด์และต้องอัปโหลดเอกสาร ส่วน OmniTrace รันเอนจินทั้งสี่ในเบราว์เซอร์ของคุณเอง และเนื้อหาไม่ถูกส่งไปที่ใดเลย';

  @override
  String get helpVsGptZero2 =>
      'ตัวชี้วัด Perplexity/Burstiness และการไฮไลต์ระดับประโยคที่ GPTZero เป็นผู้บุกเบิก OmniTrace ได้นำมาใช้ พร้อมเสริมด้วยตัวจำแนก Transformer, การวิเคราะห์รูปแบบการเขียน และการป้องกันเชิงต่อต้าน ทำให้เกิดการโหวตแบบรวมกลุ่มสี่โมเดลแทนที่จะใช้ตัวชี้วัดเดียว';

  @override
  String get helpVsGptZero3 =>
      'GPTZero เป็นระบบสมัครสมาชิก ในขณะที่ OmniTrace ไม่ต้องสมัครสมาชิกและไม่จำกัดจำนวนการใช้งาน';
  ...
  String get helpVsTurnitin1 =>
      'Turnitin จำหน่ายให้เฉพาะสถาบันเท่านั้น บุคคลทั่วไปไม่สามารถซื้อได้โดยตรง ในขณะที่ OmniTrace ใครก็สามารถติดตั้งและใช้งานได้';

  @override
  String get helpVsTurnitin2 =>
      'กระบวนการตัดสินของ Turnitin ค่อนข้างเป็นกล่องดำ ในขณะที่ OmniTrace ให้ความน่าจะเป็น AI รายประโยค รูปแบบการเขียนที่ตรงกัน และรายละเอียดคะแนนพร้อมเหตุผลของแต่ละเอนจินทั้งสี่';

  @override
  String get helpVsTurnitin3 =>
      'Turnitin ให้การตัดสินแบบสองทางเลือกว่า \"เป็น AI หรือไม่\" เป็นหลัก ในขณะที่ OmniTrace รองรับการทำเครื่องหมายระดับย่อหน้า/ประโยคว่าเป็นมนุษย์/AI/ผสม';
  ...
  String get helpVsOriginality1 =>
      'Originality.ai คิดค่าบริการรายชิ้นแบบสมัครสมาชิกและต้องอัปโหลดขึ้นคลาวด์ ส่วน OmniTrace ทำงานหลักในเบราว์เซอร์ ไม่ต้องสมัครสมาชิกและไม่จำกัดจำนวนครั้ง';

  @override
  String get helpVsOriginality2 =>
      'Originality.ai มีแนวคิดการตรวจสอบข้อเท็จจริงและการวิเคราะห์ความอ่านง่าย OmniTrace ตอบสนองด้วยโมดูลลักษณะการเขียนบนอุปกรณ์ และสามารถวิเคราะห์พื้นฐานได้แม้ออฟไลน์';
  ...
  String get helpVsCopyleaks1 =>
      'Copyleaks ใช้ API บนคลาวด์เป็นหลัก จุดแข็งคืออัตราผลบวกลวงต่ำและรองรับหลายภาษาได้ดี OmniTrace ใช้แนวคิดเดียวกันด้วยโมเดลพื้นฐานหลายภาษา XLM-RoBERTa และการโหวตแบบรวมหลายโมเดล แต่เนื้อหาเอกสารจะไม่ถูกอัปโหลดไปยังเซิร์ฟเวอร์ใดๆ';

  @override
  String get helpVsCopyleaks2 =>
      'Copyleaks มีข้อจำกัดการใช้งาน API ขึ้นอยู่กับแผนบริการ ในขณะที่ OmniTrace ไม่มีข้อจำกัดการใช้งาน';
  ...
  String get helpVsWinston1 =>
      'OCR รูปภาพของ Winston AI จะอัปโหลดภาพขึ้นคลาวด์ ส่วน OCR ของ OmniTrace จะใช้เซิร์ฟเวอร์ OCR ในเครื่องที่คุณตั้งค่าไว้ก่อน และจะใช้คลาวด์เป็นตัวสำรองก็ต่อเมื่อคุณให้คีย์ Gemini API เอง — จะใช้คลาวด์หรือไม่ขึ้นอยู่กับคุณ';

  @override
  String get helpVsWinston2 =>
      'Winston AI มีชื่อเสียงด้านการจัดวางรายงานที่สวยงาม OmniTrace นำเสนอการสร้างรูปแบบรายงานแบบไดนามิกโดย AI（กลับไปใช้เทมเพลตอัตโนมัติเมื่อไม่ได้ติดตั้ง LLM）และสามารถส่งออกได้ทั้งสี่รูปแบบ PDF/CSV/JSON/PNG';

  @override
  String get helpAdvantagesTitle => 'จุดเด่นเฉพาะของ OmniTrace';
  ...
  String get privacyWebOverview1 =>
      'OmniTrace ทำงานเป็นเว็บแอปทั้งหมดในแท็บเบราว์เซอร์ของคุณ ไม่ต้องติดตั้งใด ๆ ข้อความในเอกสารและผลการวิเคราะห์จะไม่ออกจากอุปกรณ์ของคุณ และโมเดลตรวจจับที่ดาวน์โหลดจะถูกแคชไว้ในที่จัดเก็บข้อมูลแบบแซนด์บ็อกซ์ของเบราว์เซอร์เอง（OPFS）เท่านั้น ไม่ใช่บนเซิร์ฟเวอร์ใด ๆ';
  ...
  String get privacyIosOverview1 =>
      'OmniTrace ไม่เก็บรวบรวมข้อมูลใดๆ ที่เชื่อมโยงกับตัวตนของคุณ และไม่ใช้ข้อมูลใดๆ เพื่อการติดตาม จึงไม่จำเป็นต้องขอสิทธิ์ App Tracking Transparency (ATT)';
  ...
  String get privacyAndroidOverview1 =>
      'OmniTrace ไม่เก็บรวบรวมข้อมูลส่วนบุคคล และไม่แบ่งปันข้อมูลผู้ใช้กับบุคคลที่สามใดๆ';
  ...
  String get privacyMacosOverview1 =>
      'OmniTrace ทำงานภายใต้ macOS App Sandbox และสามารถเข้าถึงได้เฉพาะไฟล์ที่คุณเลือกด้วยตนเองผ่านกล่องโต้ตอบไฟล์ของระบบ（files.user-selected.read-write）เท่านั้น ไม่สามารถเรียกดูหรือเข้าถึงไฟล์หรือโฟลเดอร์อื่นได้เอง';
  ...
  String get privacyWindowsOverview1 =>
      'OmniTrace เป็นแอปเดสก์ท็อปแบบสแตนด์อโลน ข้อมูลจัดเก็บในโฟลเดอร์ผู้ใช้ในเครื่องของคุณ（เช่น AppData／Documents）และจะไม่ซิงค์ไปยังคลาวด์';
  ...
  String get privacyDataHandling1 =>
      'OmniTrace ไม่มีบัญชีผู้ใช้ ไม่ต้องเข้าสู่ระบบ และไม่มี SDK โฆษณาหรือการติดตามจากบุคคลที่สามในรูปแบบใดๆ';

  @override
  String get privacyDataHandling2 =>
      'เนื้อหาเอกสารที่คุณพิมพ์ วาง หรือนำเข้า จะถูกวิเคราะห์โดยโมเดล AI ในเครื่องบนอุปกรณ์ของคุณทั้งหมด จะไม่ถูกอัปโหลดไปยัง OmniTrace หรือเซิร์ฟเวอร์บุคคลที่สามใดๆ';

  @override
  String get privacyDataHandling3 =>
      'ผลการวิเคราะห์และประวัติจะถูกจัดเก็บเฉพาะในฐานข้อมูลในเครื่องของอุปกรณ์คุณเท่านั้น การถอนการติดตั้งแอปหรือล้างประวัติจะลบข้อมูลเหล่านี้ทั้งหมด OmniTrace จะไม่เก็บสำเนาไว้ที่ใดเลย';
  ...
  String get privacyDisclaimer =>
      'เนื้อหาในหน้านี้เป็นคำอธิบายด้านความเป็นส่วนตัวที่ OmniTrace เขียนขึ้นตามพฤติกรรมการทำงานจริง ไม่ใช่เอกสารทางกฎหมายที่ผ่านการตรวจสอบโดยทนายความ หากต้องการการตรวจสอบการปฏิบัติตามกฎหมายอย่างเป็นทางการตามกฎหมายในภูมิภาคของคุณ แนะนำให้ปรึกษาที่ปรึกษากฎหมายมืออาชีพแยกต่างหาก';
  ...
  String get firstRunModelManualBody =>
      'คุณดาวน์โหลดเองได้ทุกเมื่อ เปิด «การตั้งค่า» (ไอคอนรูปเฟืองบนแถบด้านบน) แล้วเลือก «การจัดการโมเดล AI» ในระหว่างนี้ OmniTrace ยังทำงานได้ด้วยเครื่องมือเชิงสถิติและเชิงรูปแบบการเขียน';

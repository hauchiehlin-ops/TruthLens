...
const _latinProfiles = <String, Set<String>>{
  'en': {
    ...
    'with', 'was', 'this', 'be', 'are', 'from', 'which', 'have', 'not', 'on',
  },
  'es': {
  ...
  'pt': {
    'de', 'que', 'não', 'uma', 'os', 'no', 'se', 'na', 'por', 'com',
    'para', 'as', 'dos', 'como', 'mas', 'ao', 'das', 'à', 'seu', 'ou',
  },
  'fr': {
    'de', 'la', 'le', 'et', 'les', 'des', 'en', 'un', 'du', 'une',
    'que', 'dans', 'qui', 'pour', 'pas', 'sur', 'au', 'par', 'plus', 'ce',
  },
  'de': {
    'der', 'die', 'und', 'den', 'von', 'das', 'mit', 'des', 'ist', 'nicht',
    'ein', 'auf', 'für', 'dem', 'eine', 'als', 'auch', 'sich', 'im', 'werden',
  },
  'id': {
    'yang', 'dan', 'di', 'itu', 'dengan', 'untuk', 'tidak', 'ini', 'dari',
    'dalam', 'akan', 'pada', 'juga', 'ke', 'karena', 'oleh', 'saya', 'kami',
    'sudah', 'bisa',
  },
  'ms': {
    'yang', 'dan', 'di', 'itu', 'dengan', 'untuk', 'tidak', 'ini', 'dari',
    'dalam', 'akan', 'pada', 'juga', 'ke', 'kerana', 'oleh', 'saya', 'kami',
    'boleh', 'adalah',
  },
};
...
DetectedLanguage detectLanguage(String raw) {
  final text = raw.trim();
  if (text.length < 12) return const DetectedLanguage(DetectedLanguage.undetermined, 0);
